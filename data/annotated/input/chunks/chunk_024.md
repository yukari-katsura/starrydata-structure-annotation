...
- papers: Oxygen permeation properties of mixed conductive Sm0.5Ca0.5FeO3 | Crystal structure and oxygen permeation properties of Sm&lt;sub&gt;1&amp;minus;&lt;/sub&gt;&lt;i&gt;&lt;sub&gt;x&lt;/sub&gt;&lt;/i&gt;Ca&lt;i&gt;&lt;sub&gt;x&lt;/sub&gt;&lt;/i&gt;FeO&lt;sub&gt;3&lt;/sub&gt; (&lt;i&gt;x&lt;/i&gt; = 0.2&amp;ndash;0.3) | Comparative investigation of dual-phase membranes containing cobalt and iron-based mixed conducting perovskite for oxygen permeation
...
- papers: Phase separation and stability in Sm0.50Sr0.50MnO3: effects of cation dopants | Huge magnetoresistance and ultrasharp metamagnetic transition in polycrystalline Sm0.5Ca0.25Sr0.25MnO3
...
- papers: Structure, thermal stability and electrical properties of Ca(V0.5Mo0.5)O3 as solid oxide fuel cell anode | The effect of Mo concentration on the electrical properties of CaV1-xMoxO3-δ (x=0.2 ÷ 0.6) anode materials for solid oxide fuel cells
...
- papers: Local-moment formation and metal-nonmetal transition in Ca1−x Y x VO3 and Ca1−x Y x TiO3
...
- papers: Thermoelectric Properties of Light-Element-Containing Zintl Compounds CaZn2−x Cu x P2 and CaMnZn1−x Cu x P2 (x = 0.0–0.2) | High Seebeck coefficientAMXP2(A= Ca and Yb;M,X= Zn, Cu and Mn) Zintl phosphides as high-temperature thermoelectric materials
...
- papers: Thermoelectric properties of calcium silicides | Effect of Na Addition on Electric Properties of Ca2Si Sintered Compacts
...
- papers: DC resistivity and thermoelectric power in Ni-Cd ferrites | []
...
- papers: Enhanced Thermoelectric Figure of Merit of Zintl Phase YbCd2-xMnxSb2 by Chemical Substitution
...
- papers: Comprehensive studies of the transformation between antiferromagnetic CeCoGe3 and heavy fermion CeFeGe3 compounds
...
- papers: Thermoelectric properties of rare earths filled CoSb3 based nanostructure skutterudite | Effects of disordered structure on thermoelectric properties of LaCeFe3CoSb12 nanocomposites
...
- papers: Specific heat, susceptibility, magnetotransport and thermoelectric power of the Kondo alloys (Ce1 xLax)Cu5In | Electrical resistivity, magnetic properties and thermoelectric power factor of the polycrystalline compound CeCu4In: Effect of La dilution
...
- papers: CeFeGe3: A concentrated Kondo compound with a stable valency and high Kondo temperature | Comprehensive studies of the transformation between antiferromagnetic CeCoGe3 and heavy fermion CeFeGe3 compounds | Anomalous frequency and temperature-dependent scattering and Hund's coupling in the almost quantum critical heavy-fermion systemCeFe2Ge2
...
- papers: Suppression of ferromagnetism in solid solution CePdxGa4−x | Thermoelectric power and resistivity studies in the Kondo-lattice system CeGa2with Sn or Al substitutions and RGa2(R identical to Ho,Dy,Tb) alloys | Transport properties of RGa2 (R=La, Ce and Sm)
...
- papers: Probing strong Kondo disorder with measurements of thermoelectric power
...
- papers: New high temperature modification of CeTiGe: structural characterization and physical properties | Ferromagnetic quantum critical behavior in heavy-fermion compounds CeTi1−xNixGe3
...
- papers: Thermoelectric power and electrical resistivity of Ce(In1-xSnx)3 and (Ce1-xLaxIn3 | Thermoelectric power of some Ce compounds of the dilute Kondo type
...
- papers: Electronic properties of CeRh1−xGexIn; evolution from an intermediate-valence to a localized 4f-state | Tuning the Pairing Interaction in a \nd\n-Wave Superconductor by Paramagnons Injected through Interfaces | Thermoelectric power of Ce-based intermediate valent systems
...
- papers: Enhanced thermoelectric properties of CePd3−xPtx | Structural, Magnetic, and Thermoelectric Properties of Some CePd3-Based Compounds
...
- papers: Thermopower and resistivity of CeRhSb and CePtSn | Magnetic, transport and specific heat measurements on CeTX (T = Pd and Pt, X = Ga, Ge and Sn)
...
- papers: Influence of Ru Substitution on the Thermoelectric Properties of Ce(Fe1-xRux)4Sb12Solid Solutions | Transport properties in the filled-skutterudite compounds RERu4Sb12 (RE La, Ce, Pr and Nd); an exotic heavy fermion semimetal CeRu4Sb12 | FP-LAPW calculations of the elastic, electronic and thermoelectric properties of the filled skutterudite CeRu4Sb12
...
- papers: High performance thermoelectrics from earth-abundant materials: Enhanced figure of merit in PbS through nanostructuring grain size | Enhanced thermoelectric properties of n-type Cl doped PbS-based materials via Bi alloying
...
- papers: Electronic nature of layered oxysulfide Sr2−xCaxCu2CoO2S2 with CoO2 planes
...
- papers: Crystal structure, oxygen nonstoichiometry, thermal expansion and conductivity of (Nd,Sr)(Fe,Co)O3−δ oxides | Crystal structure, thermal expansion and electrical conductivity of Nd0.7Sr0.3Fe1−xCoxO3 (0≤x≤0.8)
...
- papers: Ca-doped HoCoO3 as p-type oxide thermoelectric material | Influence of ionic size of rare-earth site on the thermoelectric properties of RCoO3-type perovskite cobalt oxides
...
- papers: Crystal structure, morphology and physical properties of LaCo1−xTixO3±δ perovskites prepared by a citric acid assisted soft chemistry synthesis | Neutron structural characterization and transport properties of the oxidized and reduced LaCo<sub>0.5</sub>Ti<sub>0.5</sub>O<sub>3</sub>perovskite oxide
...
- papers: Enhancement of thermoelectric properties in the Nb–Co–Sn half-Heusler/Heusler system through spontaneous inclusion of a coherent second phase | The effect of Sn doping on thermoelectric performance of n-type half-Heusler NbCoSb | Impact of Nb vacancies and p-type doping of the NbCoSn–NbCoSb half-Heusler thermoelectrics
...
- papers: Effects of Tl-filling into the voids and Rh substitution for Co on the thermoelectric properties of CoSb3 | Study of transport properties of the Co1−xRhxSb3
...
- papers: Thermoelectric properties and electronic structure of CoSb3 doped with Se and Te | Structure and thermoelectric properties of Se- and Se/Te-doped CoSb 3  skutterudites synthesized by high-pressure technique
...
- papers: Effects of spin entropy and lattice strain from mixed-trivalent Fe3+/Cr3+on the electronic, thermoelectric and optical properties of delafossite CuFe1−xCrxO2(x  =  0.25, 0.5, 0.75) | High temperature thermoelectric power studies of Cu–Cr ferrites
...
- papers: CuCrSe2\n Ternary Chromium Chalcogenide: Facile Fabrication, Doping and Thermoelectric Properties | Influence of cation substitution on electrical conductivity of the n-type CuxInyCrzSe4 spinels
...
- papers: Property optimization for strontium-rich lanthanum chromium ferrite cathodes: A demonstration of lanthanide replacement effect | Enhanced CO<sub>2</sub> electrolysis through modulation of oxygen vacancies | Sr-rich chromium ferrites as symmetrical solid oxide fuel cell electrodes
...
- papers: Fabrication of Ti1^|^minus;xCrxOz and Analysis of Its Microstructure and Thermoelectric Properties
...
- papers: Physical properties of Cr1−xTixSiyyyand Cr1−xTaxSi2+y solid solutions
...
- papers: Microstructure and phase stability of W-Cr alloy prepared by spark plasma sintering
...
- papers: α-CsCu5Se3: Discovery of a Low-Cost Bulk Selenide with High Thermoelectric Performance
...
- papers: Temperature-dependence thermoelectric power studies of mixed Ni–Cu nano ferrites | High-temperature thermoelectric power studies of copper substituted nickel ferrites
...
- papers: Thermoelectric properties of n-type cobalt doped chalcopyrite Cu1−xCoxFeS2 and p-type eskebornite CuFeSe2 | Colloidal Synthesis and Thermoelectric Properties of CuFeSe2 Nanocrystals
...
- papers: Solid-state chemistry of high-temperature oxide superconductors: The experimental situation | Structural and superconducting properties of the system La1−xPrSrxCuO4
...
- papers: Thermoelectric transport properties of PbTe-based composites incorporated with Cu2Se nano-inclusions | Coherent Sb/CuTe Core/Shell Nanostructure with Large Strain Contrast Boosting the Thermoelectric Performance of n‐Type PbTe | Remarkable Roles of Cu To Synergistically Optimize Phonon and Carrier Transport in n-Type PbTe-Cu2Te
...
- papers: Crystal structure, electronic band structure and high-temperature thermoelectric properties of Te-substituted tetrahedrites Cu12Sb4−xTexS13(0.5 ≤ x ≤ 2.0) | Exsolution Process as a Route toward Extremely Low Thermal Conductivity in Cu12Sb4–xTexS13Tetrahedrites
...
- papers: Improved Thermoelectric Performance in Cu-Based Ternary Chalcogenides Using S for Se Substitution | Improved thermoelectric performance of solid solution Cu4Sn7.5S16 through isoelectronic substitution of Se for S | Boosting Thermoelectric Performance of Cu2SnSe3 via Comprehensive Band Structure Regulation and Intensified Phonon Scattering by Multidimensional Defects
...
- papers: Transport and magnetic properties in the Dy1−xCaxVO3 ceramics
...
- papers: High-temperature thermoelectric properties of half-Heusler phases Er1-xHoxNiSb
...
- papers: High-temperature thermoelectric properties of Sr2RuYO6 and Sr2RuErO6 double perovskites influenced by structure and microstructure | High-temperature thermoelectric properties of the double-perovskite ruthenium oxide (Sr1−xLax)2ErRuO6
...
- papers: Structural, electrical, magnetic and thermal studies on Eu 1-x Sr x MnO 3  (0.2 ≤  x  ≤ 0.5) manganites | Modification of low temperature magnetic interactions in Dy1−xEuxMnO3 | Structural, transport, and magnetic properties of RMnO3 perovskites (R=La, Pr, Nd, Sm, 153Eu, Dy)
