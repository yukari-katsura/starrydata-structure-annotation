...
- papers: Effects of a Cu-contained compound on the microstructures and thermoelectric properties of Zn–Sb based alloys | Thermoelectric properties of Cu-added Zn–Sb based alloys with multi-phase equilibrium | Thermoelectric efficiency of intermetallic compound ZnSb
...
- papers: Enhanced seebeck coefficient and low thermal conductivity of Cu2SexTe1-x solid solutions via minority carrier blocking and interfacial effects
...
- papers: Modification of low temperature magnetic interactions in Dy1−xEuxMnO3
...
- papers: Substitution effect on the thermoelectric properties of p-type half-Heusler compounds: ErNi1−xPdxSb
...
- papers: Structural, electrical, magnetic and thermal studies on Eu 1-x Sr x MnO 3  (0.2 ≤  x  ≤ 0.5) manganites
...
- papers: Magnetothermopower in Nd1−xEuxNiO3 compounds
...
- papers: Electrical properties of fluorine-intercalated layered manganite: La 1.4 Sr 1.6 Mn 2 O 7 F 2
...
- papers: Abnormal Resistance and Magnetoresistance Temperature Dependence in Fe-Semiconductor Granular Films
...
- papers: Electrochemical Performance of La 1.5 Sr 0.5 Ni 1-x Fe x O 4+ δ Cathode for IT-SOFCs | Performance evaluation of highly active and novel La0.7Sr0.3Ti0.1Fe0.6Ni0.3O3-δ material both as cathode and anode for intermediate-temperature symmetrical solid oxide fuel cell
...
- papers: Thermoelectric Properties of Fe-Mn-Si Alloys and Compound Fe3Si doped with Mn and V
...
- papers: Synthesis, structure and properties of new layered oxyselenides Nd2(Fe1−xMnx)2Se2O3
...
- papers: Probing local distortion around structural defects in half-Heusler thermoelectric NiZrSn alloy

## Fe-Na-O-Ta
- rank 1722 | 3 samples | 1 papers | 1 compositions
- compositions: (Fe2O3)NaTaO3 (3)
- measured range: 566-1047 K (5th-95th pct of 3 curves)
- papers: SPS-sintered NaTaO3–Fe2O3 composite exhibits enhanced Seebeck coefficient and electric current
...
- papers: Thermoelectric properties of p-type skutterudites YbxFe3.5Ni0.5Sb12 (0.8⩽x⩽1) | Thermoelectric performance of p-type skutterudites YbxFe4−yPtySb12 (0.8 ≤ x ≤ 1, y = 1 and 0.5) | Thermoelectric Transport Properties of RyFe3NiSb12 (R = Ba, Nd and Yb)
...
- papers: Structural, electronic, magnetic and thermoelectric properties of pseudobrookite-type Fe2-xTi1+xO5 (x = 0, 0.5 and 1) compounds: DFT + U approaches
...
- papers: Preparation and thermoelectric properties of p-type Pr z Fe4− x Co x Sb12 skutterudites | High-temperature electrical and thermal transport properties of fully filled skutterudites RFe4Sb12 (R = Ca, Sr, Ba, La, Ce, Pr, Nd, Eu, and Yb)
...
- papers: Roles of spin fluctuations and rattling in magnetic and thermoelectric properties of AT4Sb12 (A=Ca, Sr, Ba, La; T=Fe, Ru, Os) | High-temperature electrical and thermal transport properties of fully filled skutterudites RFe4Sb12 (R = Ca, Sr, Ba, La, Ce, Pr, Nd, Eu, and Yb)
...
- papers: Thermoelectric properties of InxGa1−xN alloys | High temperature thermoelectric properties of optimized InGaN | Thermoelectric Properties of In0.3Ga0.7N Alloys
...
- papers: Thermoelectric Characterization of (Ga,In)2Te3 with Self-Assembled Two-Dimensional Vacancy Planes
...
- papers: Synthesis, Structure, Thermoelectric Properties, and Band Gaps of Alkali Metal Containing Type I Clathrates: A8Ga8Si38(A = K, Rb, Cs) and K8Al8Si38 | Synthesis and thermoelectric properties of the quaternary type-I Si clathrates K 8-δ Ga x Al y Si 46-x-y
...
- papers: Thermoelectric properties and impedance spectroscopy of polycrystalline samples of the beta-gallia rutile intergrowth, (Ga,In)4(Sn,Ti)5O16
...
- papers: Thermal Property of Magnetic Materials for Hydrogen Magnetic Refrigeration and Effect of Magnetic Field on Them | Thermal transport properties of magnetic refrigerants La(FexSi1−x)13 and their hydrides, and Gd5Si2Ge2 and MnAs | Outstanding Comprehensive Performance of La(Fe, Si)<sub>13</sub>H<sub>y</sub>/In Composite with Durable Service Life for Magnetic Refrigeration
...
- papers: Enhancement of high temperature thermoelectric properties of intermetallic compounds based on a Skutterudite IrSb3and a half-Heusler TiNiSb | Effect of partial la filling on high-temperature thermoelectric properties of IrSb3-based skutterudite compounds
...
- papers: Physical properties of polycrystalline Dy2PdGe6 and La2PdGe6 | Crystal structure and physical properties of LaPd2Ge and a novel compound LaPdGe3
...
- papers: Effects of Mn substitution on the phases and thermoelectric properties of Ge0.8Pb0.2Te alloy
...
- papers: Synthesis, Structure, and Transport Properties of Type-I Derived Clathrate Ge46–xPxSe8–y(x= 15.4(1);y= 0–2.65) with Diverse Host–Guest Bonding

## H-Ni-P
- rank 1739 | 3 samples | 1 papers | 1 compositions
- compositions: NiTPP (3)
- measured range: 300-380 K (5th-95th pct of 3 curves)
- papers: Polaron activation energy of nano porphyrin nickel(II) thin films

## H-P-V
- rank 1740 | 3 samples | 1 papers | 1 compositions
- compositions: PTVT2T (3)
- measured range: 281-380 K (5th-95th pct of 9 curves)
- papers: Two soluble polymers with lower ionization potentials: doping and thermoelectric properties
...
- papers: Thermoelectric properties and electronic transport analysis of Zr3Ni3Sb4-based solid solutions | Thermoelectric properties of ternary transition metal antimonides
...
- papers: Thermoelectric Seebeck effect in oxide-based resistive switching memory
...
- papers: High-temperature power factor of half-Heusler phases RENiSb (RE = Sc, Dy, Ho, Er, Tm, Lu) | High-temperature thermoelectric properties of half-Heusler phases Er1-xHoxNiSb | Observed Properties and Electronic Structure of RNiSb Compounds (R = Ho, Er, Tm, Yb and Y). Potential Thermoelectric Materials
...
- papers: Thermal and thermoelectric properties of III-nitride and III-oxynitride films | Thermoelectric properties of Al1−xInxN and InOsNtprepared by reactive radio frequency sputtering
...
- papers: Thermoelectric Properties of Te-doped In0.9Si0.1Se with Enhanced Effective Mass
...
- papers: Novel n-type thermoelectric material of ZnIn2Se4
...
- papers: Emergence of Insulating Ferrimagnetism and Perpendicular Magnetic Anisotropy in 3d–5d Perovskite Oxide Composite Films for Insulator Spintronics
...
- papers: Metal–Insulator Transition in Pyrochlore IridatesLn2Ir2O7(Ln= Nd, Sm, and Eu) | Unified description of resistivity and thermopower of<mml:math xmlns:mml=\"http://www.w3.org/1998/Math/MathML\"><mml:mrow><mml:msub><mml:mi>Pr</mml:mi><mml:mn>2</mml:mn></mml:msub><mml:msub><mml:mi>Ir</mml:mi><mml:mn>2</mml:mn></mml:msub><mml:msub><mml:mi mathvariant=\"normal\">O</mml:mi><mml:mn>7</mml:mn></mml:msub></mml:mrow></mml:math>: Possible influence of crystal field excitation in a Kondo lattice
...
- papers: Comments upon ?the thermoelectric power of someThCe alloys? and an alternate suggestion
