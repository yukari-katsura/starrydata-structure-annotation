...
- papers: Transport and magnetic properties of new ternary Ce2T3X9-compounds (T=Rh, Ir, X=Al, Ga)
...
- papers: Thermoelectric power of Ce-based Kondo alloys
...
- papers: A study on the antiferromagnetic behavior of the hydride CeRuGeH adopting the ZrCuSiAs-type structure
...
- papers: Ferromagnetism and transport properties of the Kondo system Ce4Sb1.5Ge1.5

## Ce-H-In-Pd
- rank 2910 | 1 samples | 1 papers | 1 compositions
- compositions: CePdInH (1)
- measured range: 12-280 K (5th-95th pct of 1 curves)
- papers: The Doniach diagram and hydrogenation of the ternary compounds CePdIn and CePdSn
...
- papers: Inducing Magnetism in the Kondo Semiconductor CeRhSb through Hydrogenation:  Antiferromagnetic Behavior of the New Hydride CeRhSbH0.2
...
- papers: Gap formation in CeNiSn at low temperatures
...
- papers: Electrical resistivity and thermoelectric power study of the heavy-fermion compounds (CexLa1−x)7Ni3
...
- papers: Thermoelectric power in compounds with an intermediate valence of Ce: phenomenological description
...
- papers: Kondo lattice behaviour in CeTSb2 compounds (T  Ni, Cu and Ag)
...
- papers: Avoided ferromagnetic quantum critical point in CeRuPO
...
- papers: Preparation and Thermophysical Properties of Sm2(Ce0.3Zr0.7)2O7 Ceramic
...
- papers: Thermoelectric Properties of Ce1−x Sc x Pd3
...
- papers: Thermoelectric Properties of Some Cerium Sulfide Semiconductors from 4° to 1300°K
...
- papers: Possible devil's staircase in the Kondo lattice CeSbSe
...
- papers: Low-temperature thermoelectric properties of the CeSe2−xSnx compounds
...
- papers: A theoretical study of the structural, thermoelectric, and spin‐orbit coupling influenced optoelectronic properties of CsTmCl\n            3\n            halide perovskite
...
- papers: Investigating the thermoelectric performance of n-type SnSe: the synergistic effect of NbCl5 doping and dislocation engineering
...
- papers: High-entropy alloys as high-temperature thermoelectric materials
...
- papers: Intermetallic Al-, Fe-, Co- and Ni-Based Thermal Barrier Coatings Prepared by Cold Spray for Applications on Low Heat Rejection Diesel Engines

## Co-Cu-Fe-Ge-Ni
- rank 2950 | 1 samples | 1 papers | 1 compositions
- compositions: FeCoNiCuGe (1)
- papers: Thin films made by reactive sputtering of high entropy alloy FeCoNiCuGe: Optical, electrical and structural properties
