...
- papers: Thermophysical characterization of ZrN and (Zr,Pu)N
...
- papers: YbN: An intrinsic semiconductor with antiferromagnetic exchange

## Na-Nb-O-Te
- rank 3505 | 1 samples | 1 papers | 1 compositions
- compositions: (NaNbO3)(TeO2) (1)
- measured range: 160-300 K (5th-95th pct of 5 curves)
- papers: Effects of inorganic salt NaNbO3 composite on the thermoelectric properties of tellurium nanorods thin slice
...
- papers: Electronic and electrochemical properties of nickel bronze, NaxNiO2
...
- papers: Structural and defect chemistry guidelines for Sr(V,Nb)O<sub>3</sub>-based SOFC anode materials
...
- papers: Large thermoelectric power factor in one-dimensional telluride Nb4SiTe4and substituted compounds
...
- papers: Spontaneously formed nanostructures in double perovskite rare-earth tantalates for thermal barrier coatings
...
- papers: Effects of Yb3+ doping on phase structure, thermal conductivity and fracture toughness of (Nd1-xYbx)2Zr2O7
...
- papers: Transport properties of the heavy-fermion superconductorPrOs4Sb12
...
- papers: Transport properties and magnetic phases of NdRu2Si2
...
- papers: Structure and physical properties of<mml:math xmlns:mml=\"http://www.w3.org/1998/Math/MathML\"><mml:mrow><mml:mi>SrNiR</mml:mi><mml:msub><mml:mi mathvariant=\"normal\">u</mml:mi><mml:mn>5</mml:mn></mml:msub><mml:msub><mml:mi mathvariant=\"normal\">O</mml:mi><mml:mn>11</mml:mn></mml:msub></mml:mrow></mml:math>single crystals: An<mml:math xmlns:mml=\"http://www.w3.org/1998/Math/MathML\"><mml:mi>R</mml:mi></mml:math>-type ferrite based on ordered kagome nets
...
- papers: Crossover between Fermi liquid and non-Fermi liquid behavior in the non-centrosymmetric compound Yb2Ni12P7
...
- papers: Substitution Effect on Thermoelectric Properties of ZrNiSn Based Half-Heusler Compounds
...
- papers: Thermoelectric figure of merit of M-sulphides (M=Fe, Co, Ni, Pd) thin films
...
- papers: Understanding of the contact of nanostructured thermoelectric n-type Bi2Te2.7Se0.3 legs for power generation applications
...
- papers: Thermoelectric Power and Electrical Resistivity of Dilute Alloys of Silicon in Copper, Nickel, and Iron
...
- papers: Role of secondary phases and thermal cycling on thermoelectric properties of TiNiSn half-Heusler alloy prepared by different processing routes
...
- papers: Anomalous Magnetic, Transport and Thermal Properties in the Half-Metallic Magnet UNiSn
...
- papers: Vanadium-Doping-Induced Resonant Energy Levels for the Enhancement of Thermoelectric Performance in Hf-Free ZrNiSn Half-Heusler Alloys
...
- papers: Thermal conductivity of Ni3V–Ni3Al pseudo-binary alloys
...
- papers: Thermophysical properties of NpO2, AmO2 and CmO2
...
- papers: Fragile singlet ground-state magnetism in the pyrochlore osmates<mml:math xmlns:mml=\"http://www.w3.org/1998/Math/MathML\"><mml:mrow><mml:msub><mml:mi>R</mml:mi><mml:mn>2</mml:mn></mml:msub><mml:msub><mml:mi>Os</mml:mi><mml:mn>2</mml:mn></mml:msub><mml:msub><mml:mi mathvariant=\"normal\">O</mml:mi><mml:mn>7</mml:mn></mml:msub></mml:mrow></mml:math>(<mml:math xmlns:mml=\"http://www.w3.org/1998/Math/MathML\"><mml:mi>R</mml:mi><mml:mo>=</mml:mo><mml:mi mathvariant=\"normal\">Y</mml:mi></mml:math>and Ho)
