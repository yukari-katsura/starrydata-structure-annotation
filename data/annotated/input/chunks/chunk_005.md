...
- sample form: Bulk (18); SingleCrystal (1)
...
- sample form: Bulk (25); SingleCrystal (4)
...
- sample form: Bulk (16); SingleCrystal (2)
...
- seed hypothesis (confirm): fega3
- sample form: Bulk (31); SingleCrystal (2)
...
- seed hypothesis (confirm): half_heusler
- sample form: Film (2); Bulk (1)   <-- film/epitaxial samples present: a metastable polymorph may be reachable here that never forms in bulk
...
- sample form: Bulk (8); rod-shaped (4)
...
- sample form: Bulk (25); Polycrystal (4)
