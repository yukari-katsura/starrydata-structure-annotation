...
- papers: Thermomagnetic and thermoelectric properties of potassium
...
- papers: Neutron structural characterization and transport properties of <i>oxidized</i> and <i>reduced</i> La<sub>0.5</sub>Sr<sub>0.5</sub>M<sub>0.5</sub>Ti<sub>0.5</sub>O<sub>3</sub> (M = Mn, Fe) perovskites: Possible electrode materials in solid-oxide fuel cells | Magnetism and giant magnetoresistance in La\n            <sub>0.7</sub>\n            Sr\n            <sub>0.3</sub>\n            Mn\n            <sub>1−x</sub>\n            M\n            <sub>x</sub>\n            O\n            <sub>3</sub>\n            (M = Cr, Ti) systems
...
- papers: Metal–insulator transition in composition-tuned nickel oxide films
...
- papers: Transport properties of SmO | Experimental determination of La2O3 thermal conductivity and its application to the thermal analysis of a-Ge/La2O3/c-Si laser annealing
...
- papers: Roles of spin fluctuations and rattling in magnetic and thermoelectric properties of AT4Sb12 (A=Ca, Sr, Ba, La; T=Fe, Ru, Os) | Transport properties of the heavy-fermion superconductorPrOs4Sb12
...
- papers: Thermoelectric power on Ce1−xLaxPd2Si2 | Antiferromagnetism in the Kondo lattice compound<mml:math xmlns:mml=\"http://www.w3.org/1998/Math/MathML\" display=\"inline\"><mml:mrow><mml:msub><mml:mrow><mml:mi mathvariant=\"normal\">Ce</mml:mi></mml:mrow><mml:mrow><mml:mn>2</mml:mn></mml:mrow></mml:msub></mml:mrow><mml:mrow><mml:msub><mml:mrow><mml:mi mathvariant=\"normal\">Pd</mml:mi></mml:mrow><mml:mrow><mml:mn>3</mml:mn></mml:mrow></mml:msub></mml:mrow><mml:mrow><mml:msub><mml:mrow><mml:mi mathvariant=\"normal\">Si</mml:mi></mml:mrow><mml:mrow><mml:mn>5</mml:mn></mml:mrow></mml:msub></mml:mrow></mml:math>
...
- papers: Electronic and magnetic properties of a new heavy-fermion compound, CeRuSn3 | Transport and magnetic properties of RERuSn3(RE=La, Ce, Pr, Nd, Sm): a heavy fermion compound CeRuSn3and a new valence fluctuating compound SmRuSn3
...
- papers: Electron and phonon scattering in the high-temperature thermoelectricLa3Te4−zMz(M=Sb,Bi)
...
- papers: Thermoelectric properties of Nb-doped (Nd 0.55 Li 0.36 )TiO 3 bulk ceramics with superlattice structure
...
- papers: Thermodynamic criterions of the thermoelectric performance enhancement in Mg2Sn through the self-compensation vacancy
...
- papers: Synthesis, Mo-valence state, thermal stability and thermoelectric properties of SrMoO3−xNx (x>1) oxynitride perovskites
...
- papers: Reduction of the thermal conductivity of the thermoelectric material ScN by Nb alloying
...
- papers: Thermal conductivity of actinide mononitride solid solutions
...
- papers: High-Mobility Electron Conduction in Oxynitride: Anatase TaON
...
- papers: Electrical and optical properties of Ta-Si-N thin films deposited by reactive magnetron sputtering
...
- papers: Thermophysical properties of thorium mononitride from 298 to 1700 K | Reactor performance and safety characteristics of ThN-UN fuel concepts in a PWR | Electrical properties of thorium nitrides
...
- papers: Reactor performance and safety characteristics of ThN-UN fuel concepts in a PWR
...
- papers: Absence of Nanostructuring in NaPbmSbTem+2: Solid Solutions with High Thermoelectric Performance in the Intermediate Temperature Regime | Sodium Substitution in Lead Telluride
...
- papers: Contrasting SnTe–NaSbTe2 and SnTe–NaBiTe2 Thermoelectric Alloys: High Performance Facilitated by Increased Cation Vacancies and Lattice Softening
...
- papers: Rich structural phase diagram and thermoelectric properties of layered tellurides Mo1−xNbxTe2 | Structural, electrical, and thermoelectric properties of distorted 1T-Ta1−xNbxTe2single crystals | Electrical Properties of a Quasi-One-Dimensional Nb3Te4Single Crystal
...
- papers: Low Thermal Conductivity of Rare-Earth Zirconate-Stannate Solid Solutions (Yb2\nZr2\nO7\n)1−x\n                        \n(Ln2\nSn2\nO7\n)\n                            x\n                        \n (Ln = Nd, Sm)
...
- papers: Band filling dependence of the electrical transport of Nd1−xAxTiO3 (A=Ca, Sr and Ba)
...
- papers: Magnetic-field induced multiple topological phases in pyrochlore iridates with Mott criticality
...
- papers: Resistivity minimum in granular composites and thin metallic films
...
- papers: Thermoelectric properties and electronic transport analysis of Zr3Ni3Sb4-based solid solutions
...
- papers: Enhanced thermoelectric power factor of half-Heusler solid solution Sc1-xTmxNiSb prepared by high-pressure high-temperature sintering method

## Np-Pd-Sn
- rank 1786 | 3 samples | 1 papers | 1 compositions
- compositions: NpPdSn (3)
- measured range: 10-296 K (5th-95th pct of 6 curves)
- papers: Magnetic and electronic properties of NpPdSn
...
- papers: Metal-insulator Crossover in Pb-Ru Based Oxides with Pyrochlore-type Structure | Flux growth and physical properties of pyrochlore Pb2Ru2O6.5 single crystals

## O-Rb-Te-V
- rank 1788 | 3 samples | 1 papers | 1 compositions
- compositions: Rb0.83V2Te2O (3)
- measured range: 11-300 K (5th-95th pct of 3 curves)
- papers: Weak metal-metal transition in the vanadium oxytelluride \n<mml:math xmlns:mml=\"http://www.w3.org/1998/Math/MathML\"><mml:mrow><mml:msub><mml:mi>Rb</mml:mi><mml:mrow><mml:mn>1</mml:mn><mml:mo>−</mml:mo><mml:mi>δ</mml:mi></mml:mrow></mml:msub><mml:msub><mml:mi mathvariant=\"normal\">V</mml:mi><mml:mn>2</mml:mn></mml:msub><mml:msub><mml:mi>Te</mml:mi><mml:mn>2</mml:mn></mml:msub><mml:mi mathvariant=\"normal\">O</mml:mi></mml:mrow></mml:math>
...
- papers: Theoretical Prediction and Experimental Investigation on the Thermal and Mechanical Properties of Bulk β-Yb2\nSi2\nO7 | Tailoring thermal properties of multi-component rare earth monosilicates | Improved thermophysical properties of rare-earth monosilicates applied as environmental barrier coatings by adjusting structural distortion with RE-doping
...
- papers: Metal-insulator transition in SrTi<sub>1−</sub><sub><i>x</i></sub>V<sub><i>x</i></sub>O<sub>3</sub>thin films
...
- papers: On the magnetic and electrical behaviour of UPdSb | Magnetic and transport properties of UPd2Sb | Uranium-based materials for thermoelectric applications
...
- papers: Transport and magnetic properties of icosahedral and glassy Pd-U-Si alloys | Low-temperature thermal conductivity of glassy and icosahedral Pd-U-Si alloys
...
- papers: Influence of quasicrystalline phase on transport processes in Zr70Pd30 amorphous alloy
...
- papers: Comments upon ?the thermoelectric power of someThCe alloys? and an alternate suggestion | Phonon and electron contributions to the thermal conductivity of \nVNx\n epitaxial layers
...
- papers: Tuning Crystal Structures and Thermoelectric Properties through Al Doping in ReSi1.75
