...
- papers: Thermal Conductivity of a Layered CsGd(MoO4)2Crystal
...
- papers: Enhanced Thermoelectric Performance in Lead-Free Inorganic CsSn1–xGexI3 Perovskite Semiconductors
...
- papers: Chemical trends of superconducting properties in pyrochlore oxides
...
- papers: High-temperature thermal conductivity of thermoelectric clathrates
...
- papers: Electrical resistivity and thermopower of Gd2Cu9 and Dy2Cu9
...
- papers: Transport properties of RInCu4 with C15b-type structure
...
- papers: Thermoelectric properties, crystal and electronic structure of semiconducting RECuSe2 (RE=Pr, Sm, Gd, Dy and Er)
...
- papers: Demagnetization due to interconfiguration fluctuations in the RE-Cu2Si2 compounds
...
- papers: Thermoelectric transport properties of CuFeInTe 3
...
- papers: Cobalt free LaxSr1-xFe1-yCuyO3-δ (x= 0.54, 0.8, y = 0.2, 0.4) perovskite structured cathode for SOFC
...
- papers: Low temperature thermoelectric and magnetoresistive properties of Tl2Cu3FeQ4 (Q = S, Se, Te)
...
- papers: Thermoelectric properties of Co0.9Fe0.1Sb3-based skutterudite nanocomposites with FeSb2 nanoinclusions
...
- papers: Valence-fluctuation behavior of Yb ions and YbCuGa
...
- papers: Thermal conductivity of the spin-Peierls compoundCuGeO3
...
- papers: Thermoelectric properties of the Cu2SnSe3–Cu2GeSe3 solid solution
...
- papers: A2Cu3In3Te8 (A = Cd, Zn, Mn, Mg): A Type of Thermoelectric Material with Complex Diamond-like Structure and Low Lattice Thermal Conductivities
...
- papers: Thermoelectric properties of p-type CuInSe2chalcopyrites enhanced by introduction of manganese
...
- papers: Semiconducting properties of Cu2In3VO9 ceramic material

## Cu-In-Sb
- rank 3094 | 1 samples | 1 papers | 1 compositions
- compositions: (InSb)5Cu1 (1)
- measured range: 316-691 K (5th-95th pct of 3 curves)
- papers: Cu addition and its role in thermoelectric properties and nanostructuring in the series compounds (InSb)nCum
...
- papers: Enhanced thermoelectric performance of a chalcopyrite compound CuIn3Se5−xTex (x = 0~0.5) through crystal structure engineering
...
- papers: Introducing kalium into copper sulfide for the enhancement of thermoelectric properties
...
- papers: Electrical and magnetic properties of new rhodium perovskites: La2MRhO6, M=Cr, Fe, Cu
