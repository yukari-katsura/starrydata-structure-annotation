...
- papers: Thermal conductivity and Seebeck coefficient of12CaO⋅7Al2O3electride with a cage structure | Positive ionic conduction of mayenite cement Ca12Al14O33/nano-carbon black composites on dielectric and thermoelectric properties | Superconducting Transition in Electron-Doped 12CaO&amp;middot;7Al&lt;SUB&gt;2&lt;/SUB&gt;O&lt;SUB&gt;3&lt;/SUB&gt;
...
- papers: Thermoelectric properties of CeAl3 prepared by hot-press method | Thermoelectric power of RAl2 | Anomalous thermopower in heavy-fermion compounds CeB6, CeAl3, and CeCu6 − x Au x
...
- papers: Thermoelectric power of RFeAsO (R=Ce, Pr, Nd, Sm and Gd) | Effects of Co doping on the transport properties and superconductivity in CeFe1 −xCoxAsO | Effects of simultaneous carrier doping in the charge reservoir and conducting layers of superconducting CeO0.9F0.1Fe1−xCoxAs
...
- papers: Investigation of ferromagnetic filled skutterudite compound EuFe4As12 | Hydrostatic pressure effects on the static magnetism in Eu(Fe0.925Co0.075)2As2
...
- papers: Electrical and thermal properties of Pr2/3(Ba1−xCsx)1/3MnO3 manganites | Magnetotransport, magnetization and thermoelectric power of Pr2/3Ba1/3MnO3 : PdO composite manganites | Thermopower studies of Pr0.67D0.33MnO3manganite system
...
- papers: On the Thermoelectric Properties of Zintl Compounds Mg3Bi2−x Pn x (Pn = P and Sb) | Electrical and thermoelectric properties of nanocrystal substitutional semiconductor alloys Mg3(BixSb1−x)2 prepared by mechanical alloying | High thermoelectric cooling performance of n-type Mg3Bi2-based materials
...
- papers: Anisotropic Multicenter Bonding and High Thermoelectric Performance in Electron-Poor CdSb | Combined effects of donor and acceptor impurities on the thermoelectric properties of cadmium antimonide | Structure of Cd12.7(1)Sb10
...
- papers: Electronic and magnetic properties of Ce3Pd5Si | Heavy fermion behavior in Ce(NixPd1−x)2Si2 | Low Temperature Thermoelectric Power of Ce(Pd $$_{1-x}$$ 1 - x Cu $$_x$$ x ) $$_2$$ 2 Si $$_2$$ 2
...
- papers: Investigation of the Thermoelectric Properties of the Series TiCo1-xNixSnxSb1-x | Ti2NiCoSnSb - a new half-Heusler type high-entropy alloy showing simultaneous increase in Seebeck coefficient and electrical conductivity for thermoelectric applications | Phase stability and thermoelectric properties of TiCoSb-TiM2Sn (M = Ni, Fe) Heusler composites
...
- papers: Effects of Structural Disorder and Charge Carriers on the Magnetic and Transport Properties of Sr0.7R0.3CoO3-δ(R= Y or Dy0.45Er0.55) | High-Temperature Thermoelectric and Microstructural Characteristics of Cobalt-Based Oxides with Ga Substituted on the Co-Site | Chemical and Physical Pressure Effects on the Magnetic and Transport Properties of the A-Site Ordered Perovskite Sr3YCo4O10.5
...
- papers: Enhanced Thermoelectric Figure of Merit in Stannite–Kuramite Solid Solutions Cu2+xFe1–xSnS4–y(x= 0–1) with Anisotropy Lowering | Magnetic ions in wide band gap semiconductor nanocrystals for optimized thermoelectric properties | Variable-range-hopping conduction and low thermal conductivity in chalcogenide spinel CuyFe4Sn12X32 (X = S, Se)
...
- papers: High-performance thermoelectric minerals: Colusites Cu26V2M6S32 (M = Ge, Sn) | Research Update: Cu–S based synthetic minerals as efficient thermoelectric materials at medium temperatures | Tunable electronic properties and low thermal conductivity in synthetic colusites Cu26−xZnxV2M6S32 (x ≤ 4, M = Ge, Sn)
...
- papers: Synthesis of Wurtzite Cu2ZnGeSe4Nanocrystals and their Thermoelectric Properties | Cu2ZnGeSe4Nanocrystals: Synthesis and Thermoelectric Properties | Influence of a Nano Phase Segregation on the Thermoelectric Properties of the p-Type Doped Stannite Compound Cu2+xZn1–xGeSe4
...
- papers: Thermoelectric properties optimization of Fe2VGa by tuning electronic density of states via titanium doping | Effects of Ge substitution on the thermoelectric properties and pseudogap characteristics of Fe2VGa | Off-stoichiometric effect on the transport and pseudogap characteristics of Fe2V Ga
...
- papers: Structure and Properties of Novel Cobalt-Free Oxides Nd<sub><i>x</i></sub>Sr<sub>1–<i>x</i></sub>Fe<sub>0.8</sub>Cu<sub>0.2</sub>O<sub>3−δ</sub> (0.3 ≤ <i>x</i> ≤ 0.7) as Cathodes of Intermediate Temperature Solid Oxide Fuel Cells | Performance of (Ln<sub>0.5</sub>M<sub>0.5</sub>)FeO<sub>3-δ</sub> Perovskites as Cathode for SOFCs.: Effect of Mean Radious of the A site Cations | Structure, electrical conducting and thermal expansion properties of Ln0.6Sr0.4Co0.2Fe0.8O3 (Ln=La, Pr, Nd, Sm) perovskite-type complex oxides
...
- papers: High-Temperature Thermoelectric Properties of Pr<sub>1−</sub><i><sub>x</sub></i>Sr<i><sub>x</sub></i>FeO<sub>3</sub> (0.1 ≤ <i>x</i> ≤ 0.7) | A novel one step synthesized Co-free perovskite/brownmillerite nanocomposite for solid oxide fuel cells | Physical properties of (SrBa)1-xPrx(CuTi)0.2Fe0.8O3-δ (x = 0–1.0) and its application in H-SOFCs
...
- papers: Thermoelectric properties of and devices based on free-standing GaN | Thermoelectric properties and thermoelectric devices of free-standing GaN and epitaxial GaN layer | Thermal Conductivity and Large Isotope Effect in GaN from First Principles
...
- papers: High-efficient thermoelectric materials: The case of orthorhombic IV-VI compounds | Thermoelectric properties of GeSe | Glass-like electronic and thermal transport in crystalline cubic germanium selenide
...
- papers: Thermoelectric power of the YbT2Zn20(T=Fe, Ru, Os, Ir, Rh, and Co) heavy fermions | Enhanced thermoelectric performance of heavy-fermion compounds YbTM2Zn20 (TM = Co, Rh, Ir) at low temperatures | Effect of Ga Substitution on the Γ3Doublet Ground State in PrIr2Zn20
...
- papers: High-Performance Pseudocubic Thermoelectric Materials from Non-cubic Chalcopyrite Compounds | High-temperature thermoelectric properties of non-stoichiometric Ag1−xInTe2 with chalcopyrite structure | Silver Indium Telluride Semiconductors and Their Solid Solutions with Cadmium Indium Telluride: Structure and Physical Properties
...
- papers: Enhanced thermoelectric performance in the very low thermal conductivity Ag2Se0.5Te0.5 | Ternary Ag2Se1–xTex: A Near-Room-Temperature Thermoelectric Material with a Potentially High Figure of Merit
...
- papers: High-entropy alloys as high-temperature thermoelectric materials | The Effect of Scandium Ternary Intergrain Precipitates in Al-Containing High-Entropy Alloys
...
- papers: Distinct impact of order degree on thermoelectric power factor of p-type full-Heusler Mn<sub>2</sub>VAl compounds | Enhancement of the thermoelectric performance of half-metallic full-Heusler Mn2VAl alloys via antisite defect engineering and Si partial substitution
...
- papers: Crystal orientation dependent thermoelectric properties of highly oriented aluminum-doped zinc oxide thin films | X-ray photoelectron spectroscopy study and thermoelectric properties of Al-doped ZnO thin films | Improved thermoelectric performance of Al and Sn doped ZnO nano particles by the engineering of secondary phases
...
- papers: Effects of Co Substitution on Magnetic and Thermoelectric Properties of BaFe4Sb12 | Roles of spin fluctuations and rattling in magnetic and thermoelectric properties of AT4Sb12 (A=Ca, Sr, Ba, La; T=Fe, Ru, Os) | Magnetic and thermoelectric properties of BayFe4−xCoxSb12
...
- papers: Fast Preparation and Characterization of Quarternary Thermoelectric Clathrates | Thermoelectric properties of silicon-germanium type I clathrates | Thermoelectric properties of Ba-filled Si-Ge alloy type I semiconducting clathrates
...
- papers: Spin–Glass-like Transition and Hall Resistivity of Y2-xBixIr2O7 | On the electrical properties of the Bi2−Sr Ir2O7 pyrochlore solid solution: Quantum ab initio and classic calculations | Possible scale invariant linear magnetoresistance in pyrochlore iridates Bi<sub>2</sub>Ir<sub>2</sub>O<sub>7</sub>
...
- papers: Structures and thermoelectric properties of double-filled (CaxCe1−x)Fe4Sb12 skutterudites | Roles of spin fluctuations and rattling in magnetic and thermoelectric properties of AT4Sb12 (A=Ca, Sr, Ba, La; T=Fe, Ru, Os) | Rare-earth free  p -type filled skutterudites: Mechanisms for low thermal conductivity and effects of Fe/Co ratio on the band structure and charge transport
...
- papers: Specific heat, susceptibility, magnetotransport and thermoelectric power of the Kondo alloys (Ce1 xLax)Cu5In | Thermoelectric power in (, Ni; , Ga) compounds | Thermpower of Ce x Y1?x InCu2 and CeInCu y Ag2?y
...
- papers: Transport properties under magnetic fields of the heavy fermion system CeRu2Si2 and related compounds (Ce, La)Ru2Si2 | Magnetic Field Driven Electronic Singularities through Metamagnetic Phenomena: Case of the Heavy Fermion Antiferromagnet Ce(Ru0.92Rh0.08)2Si2 | Anomalous ferromagnetism and non-Fermi-liquid behavior in the Kondo lattice CeRuSi2
...
- papers: Enhancement of thermoelectric power factor by inducing octahedral ordering in \nLa2−xSrxCoFeO6\n double perovskites | Magnetic glass state and magnetoresistance in SrLaFeCoO<sub>6</sub>double perovskite | Decreasing the polarization resistance of LaSrCoO4 cathode by Fe substitution for Ba(Zr0.1Ce0.7Y0.2)O3 based protonic ceramic fuel cells
...
- papers: Thermoelectric properties of p-type Fe-doped TiCoSb half-Heusler compounds | Phase stability and thermoelectric properties of TiCoSb-TiM2Sn (M = Ni, Fe) Heusler composites | The half Heusler system Ti<sub>1+x</sub>Fe<sub>1.33−x</sub>Sb–TiCoSb with Sb/Sn substitution: phase relations, crystal structures and thermoelectric properties
...
- papers: Lattice crossover and mixed valency in the LaCo1−xRhxO3 solid solution
...
- papers: CuCrSe2\n Ternary Chromium Chalcogenide: Facile Fabrication, Doping and Thermoelectric Properties | Thermoelectric properties of p-type CuInSe2chalcopyrites enhanced by introduction of manganese | The electric and thermoelectric properties of CuInSe2-based chalcopyrite
...
- papers: Synthesis and Superconductivity in Ba-doped (Ru,Cu)(Sr,Nd)2(Nd,Ce)2Cu2O z Compounds | Transport and NQR Studies of Nd1.6-xCexSr0.4CuO4with T*Structure
...
- papers: Thermoelectric properties of RE2−xMxCuO4oxide sintering bulks | Thermoelectric properties of layered rare earth copper oxides | Anomalous thermopower of the electron-doped superconductor, Sm2−xCexCuO4
...
- papers: Good Solid‐State Electrolytes Have Low, Glass‐Like Thermal Conductivity | Effect of Boundaries and Isotopes on the Thermal Conductivity of LiF | Isotope scattering and phonon thermal conductivity in light atom compounds: LiH and LiF
...
- papers: La<sub>0.3</sub>Sr<sub>0.7</sub>Ti<sub>0.3</sub>Fe<sub>0.7</sub>O<sub>3-δ</sub>-Based Electrodes for Symmetrical Solid Oxide Fuel Cells by A-Site Deficiency Manipulation | Neutron structural characterization and transport properties of <i>oxidized</i> and <i>reduced</i> La<sub>0.5</sub>Sr<sub>0.5</sub>M<sub>0.5</sub>Ti<sub>0.5</sub>O<sub>3</sub> (M = Mn, Fe) perovskites: Possible electrode materials in solid-oxide fuel cells | Cobalt and Titanium substituted SrFeO3 based perovskite as efficient symmetrical electrode for solid oxide fuel cell
...
- papers: Decoupling Interrelated Parameters for Designing High Performance Thermoelectric Materials | Discovery of TaFeSb-based half-Heuslers with high thermoelectric performance | High‐Pressure‐Sintering‐Induced Microstructural Engineering for an Ultimate Phonon Scattering of Thermoelectric Half‐Heusler Compounds
...
- papers: Enhancing the Thermoelectric Properties of Germanium Antimony Tellurides by Substitution with Selenium in Compounds GenSb2(Te1–xSex)n+3(0 ≤x≤ 0.5;n≥ 7) | Thermoelectric properties in nanostructured homologous series alloys GamSbnTe1.5(m+n) | Nanostructuring and Thermoelectric Characterization of (GaSb)3(1−x)(Ga2Te3) x
...
- papers: Phase-transition temperature suppression to achieve cubic GeTe and high thermoelectric performance by Bi and Mn codoping | Dramatically enhanced Seebeck coefficient in GeMnTe2–NaBiTe2 alloys by tuning the Spin's thermodynamic entropy | Rhombohedral to Cubic Conversion of GeTe via MnTe Alloying Leads to Ultralow Thermal Conductivity, Electronic Band Convergence, and High Thermoelectric Performance
...
- papers: High thermoelectric performance of Ge1−xPbxSe0.5Te0.5 due to (Pb, Se) co-doping | Influence of Se Substitution in GeTe on Phase and Thermoelectric Properties | Glass-like electronic and thermal transport in crystalline cubic germanium selenide
...
- papers: Combinatorial Synthesis and Characterization of Thermoelectric Composition-Spread (La<sub>1-x</sub>Ca<sub>x</sub>)VO<sub>3</sub> (0≤x≤1) Films | Thermoelectric response in the incoherent transport region near Mott transition: The case study of La1−xSrxVO3
...
- papers: Large thermoelectric power in several metallic compounds of cerium and uranium | The effective increase in atomic scale disorder by doping and superconductivity in Ca3Rh4Sn13 | Thermoelectric Properties of Single-Crystal CeRhSn with Valence Fluctuations
...
- papers: Thermoelectric properties of nanocrystalline (Mg1−xZnx)3Sb2isostructural solid solutions fabricated by mechanical alloying | Structural and physical properties of Mg3−xZnxSb2 (x=0–1.34) | Significantly enhanced thermoelectric properties of p-type Mg3Sb2 via co-doping of Na and Zn
