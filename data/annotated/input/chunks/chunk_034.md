...
- papers: Dimensional crossover of charge density wave and thermoelectric properties in CeTe2−xSbx single crystals
...
- papers: Influence of partial substitution of Cu for Co on the thermoelectric properties of NaCo2O4 | Thermoelectric Solid-Oxide Fuel Cells with Extra Power Conversion from Waste Heat | Microstructure and high-temperature thermoelectric properties of Cu-doped NaCo/sub 2/O/sub 4/
...
- papers: Double perovskite Pr2CoFeO6 thermoelectric oxide: Roles of Sr-doping and Micro/nanostructuring
...
- papers: Investigation of structural and temperature dependent electromagnetic properties of CoZnCrFeO
...
- papers: Exploring the thermoelectric behavior of spark plasma sintered Fe7-xCoxS8 compounds
...
- papers: Thermoelectric and electrical resistivity study of Hitperm alloys
...
- papers: Electrical conductivity and thermoelectric power of LaCo1 − x Ga x O3 solid solutions
...
- papers: The crystal structure, transport and thermodynamic properties of ThCoGa4single crystals
...
- papers: Heterostructures of skutterudites and germanium antimony tellurides – structure analysis and thermoelectric properties of bulk samples | Effects of Double Substitution with Ge and Te on Thermoelectric Properties of a Skutterudite Compound
...
- papers: Anomalous transport properties of the half-metallic ferromagnets Co2TiSi, Co2TiGe and Co2TiSn | Itinerant half-metallic ferromagnetsCo2TiZ(Z=Si, Ge, Sn):Ab initiocalculations and measurement of the electronic structure and transport properties | Anomalous Hall Effect and Magnetoresistance in Sputter‐Deposited Magnetic Weyl Semimetal Co\n            <sub>2</sub>\n            TiGe Thin Films
...
- papers: Thermoelectric performance of nanostructured p-type Zr0.5Hf0.5Co0.4Rh0.6Sb1−xSnx half-Heusler alloys
...
- papers: Iodine-filled FexCo4−xSb12 polycrystals: Synthesis, structure, and thermoelectric properties
...
- papers: High temperature thermoelectric properties of CoTiSb half-Heusler compounds
...
- papers: Effects of scandium doping concentration on the properties of strontium cobalt oxide membranes
...
- papers: Structural Characterization and Thermoelectric Properties of Hot-Pressed CoSi Nanocomposites
...
- papers: Frustrated magnetism in the tetragonal CoSe analog of superconducting FeSe
...
- papers: Thermoelectric Properties of Co4Sn6Se6 Ternary Skutterudites
...
- papers: Transport phenomena in spin fluctuations systems | The transport properties of RCo2compounds | Transport properties in CeCo2 single crystal
...
- papers: Preparation of Some Chalcogenide Spinel Single Crystals and Their Electronic Properties | Electrical Transport in FeCr2S4‐CuCr2S4 Spinels
...
- papers: Comparison of thermoelectric properties of p-type nanostructured bulk Si0.8Ge0.2 alloy with Si0.8Ge0.2 composites embedded with CrSi2 nano-inclusisons
...
- papers: Thermoelectric properties of Cr 1−x Mo x Si 2

## Cs-N-Si
- rank 1679 | 3 samples | 1 papers | 1 compositions
- compositions: Si NCs (3)
- measured range: 321-449 K (5th-95th pct of 6 curves)
- papers: Pseudo-direct bandgap transitions in silicon nanocrystals: effects on optoelectronics and thermoelectrics
...
- papers: Synthesis and transport properties of type II clathrates | Temperature dependent structural and transport properties of the type II clathrates A8Na16E136 (A=Cs or Rb and E=Ge or Si)
...
- papers: Anomalous lattice expansion of RuSr2Eu1.5Ce0.5Cu2O10−δ (Ru-1222) magneto superconductor: A low temperature X-ray diffraction study | Synthesis and physical properties of superconducting RuSr2EuCu2O8
...
- papers: Structure and superconductivity in new Nb-based cuprates (Nb,Ti,Cu)Sr2EuCu2Oz | Percolative superconductivity in electron-doped \n<mml:math xmlns:mml=\"http://www.w3.org/1998/Math/MathML\"><mml:mrow><mml:msub><mml:mi>Sr</mml:mi><mml:mrow><mml:mn>1</mml:mn><mml:mo>−</mml:mo><mml:mi>x</mml:mi></mml:mrow></mml:msub><mml:msub><mml:mi>Eu</mml:mi><mml:mi>x</mml:mi></mml:msub><mml:msub><mml:mi>CuO</mml:mi><mml:mrow><mml:mn>2</mml:mn><mml:mo>+</mml:mo><mml:mi>y</mml:mi></mml:mrow></mml:msub></mml:mrow></mml:math>\n films
...
- papers: Copper doped SrFe0.9-Cu W0.1O3- (x = 0–0.3) perovskites as cathode materials for IT-SOFCs | Electrochemical performance of novel cobalt-free perovskite SrFe0.7Cu0.3O3-δ cathode for intermediate temperature solid oxide fuel cells | Insights into the oxygen reduction reaction on Cu-doped SrFeO3- cathode for solid oxide fuel cells
...
- papers: Thermoelectric power studies of zinc substituted copper ferrites | Investigation of structural and temperature dependent electromagnetic properties of CoZnCrFeO
...
- papers: Influence of rare earth doping on thermoelectric properties of SrTiO3 ceramics | Interplay of chemical expansion, Yb valence, and low temperature thermoelectricity in the YbCu2Si2−xGex solid solution | de Haas–van Alphen Effect and Fermi Surface Properties in High-Quality Single Crystals YbCu2Si2and YbCu2Ge2
...
- papers: Thermoelectric Properties of Cu2HgSnSe4-Cu2HgSnTe4 Solid Solution
...
- papers: Single crystal study on a dense Kondo antiferromagnet UCu5In
...
- papers: Assessment of LaM0.25Mn0.75O3- (M = Fe, Co, Ni, Cu) as promising cathode materials for intermediate-temperature solid oxide fuel cells | Evaluation of La[sub 0.8]Sr[sub 0.2]Cu[sub 1−x]Mn[sub x]O[sub y] Double Perovskite for Use in SOFCs | Evaluation of La0.8Sr0.2Cu1-xMnxOd Double Perovskite for Use in SOFCs
...
- papers: Preparation and electrical and magnetic properties of Sr2?xNaxCuO3 (0 ? x ? 1) solid solutions
...
- papers: Pressure studies on the electrical properties in R2-xSrxNi1-yCuyO4+δ(R=La, Nd) and La3Ni2O7+δ
...
- measured range: 10-298 K (5th-95th pct of 3 curves)
- papers: Thermopower of Yb Heavy Fermion Compounds at High Pressure

## Cu-O-Sb-Se-Sr
- rank 1696 | 3 samples | 1 papers | 1 compositions
- compositions: SrOCuSbSe2 (3)
- measured range: 140-851 K (5th-95th pct of 11 curves)
- papers: Observation of High Seebeck Coefficient and Low Thermal Conductivity in [SrO]-Intercalated CuSbSe2 Compound
...
- papers: The electrical properties of Cu2Se + Cu2O composites
...
- papers: Thermoelectric Transport in Cu7PSe6with High Copper Ionic Mobility | High Electron Mobility and Disorder Induced by Silver Ion Migration Lead to Good Thermoelectric Performance in the Argyrodite Ag8SiSe6
...
- papers: Ultrahigh Thermoelectric Performance in Mosaic Crystals
