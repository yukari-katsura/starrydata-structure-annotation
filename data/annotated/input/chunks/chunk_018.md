...
- papers: Thermoelectric and transport properties of sintered n-type K8Ba16Ga40Sn96 with type-II clathrate structure | Off-center rattling and thermoelectric properties of type-II clathrate (K, Ba)24(Ga, Sn,□)136single crystals | Power generation characteristics of thermoelectric conversion module using type-II (K,Ba)24(Ga,Sn)136 and type-VIII Ba8Ga16(Sn,Ge)30 clathrates
...
- papers: Thermoelectric properties of BaSi2, SrSi2, and LaSi | Thermoelectric Properties of La-Doped BaSi<SUB>2</SUB> | Low-temperature magnetic, galvanomagnetic, and thermoelectric properties of the type-I clathrates Ba8NixSi46−x
...
- papers: Beryllides for fusion reactors
...
- papers: Thermoelectric properties of Bi-based Zintl compounds Ca1−xYbxMg2Bi2 | Enhanced thermoelectric performance of P-type CaMg2Bi1.98 and optimized CaAl2Si2-type Zintl phase module with equal cross-section area
...
- papers: Thermoelectric power ofBi2Sr2Ca1−xYxCu2O8+y | Microstructure, localizedCu2+spins, and transport properties ofBi2Sr2Ca1−xYxCu2O8+δ
...
- papers: Thermoelectric performance of quaternary Cu–Bi–Sb–Te alloys prepared by cold pressing | High thermoelectric properties of p-type pseudobinary (Cu4Te3)x–(Bi0.5Sb1.5Te3)1−x alloys prepared by spark plasma sintering | Facile synthesis of Cu7Te4 nanorods and the enhanced thermoelectric properties of Cu7Te4–Bi0.4Sb1.6Te3 nanocomposites
...
- papers: Structure inhomogeneities, shallow defects, and charge transport in the series of thermoelectric materials K2Bi8−xSbxSe13 | n-to-p Transition on K2Bi8-xSbxSe13 Series
...
- papers: Thermoelectric transport properties of CaMg2Bi2, EuMg2Bi2, and YbMg2Bi2 | Thermoelectric properties of Bi-based Zintl compounds Ca1−xYbxMg2Bi2 | Enhanced thermoelectric properties of Zintl phase YbMg2Bi1.98 through Bi site substitution with Sb
...
- papers: Thermoelectric Properties of CuO-Added AgSbO3 Ceramics | Transport, thermal and magnetic properties of Bi3Os3O11 and Bi3Ru3O11 | Oxygen vacancy control in the defect pyrochlore: a way to tune the electronic bandwidth
...
- papers: Low lattice thermal conductivity in Pb5Bi6Se14, Pb3Bi2S6, and PbBi2S4: promising thermoelectric materials in the cannizzarite, lillianite, and galenobismuthite homologous series | High performance thermoelectrics from earth-abundant materials: Enhanced figure of merit in PbS through nanostructuring grain size | PbmBi2S3+m Homologous Series with Low Thermal Conductivity Prepared by the Solution-Based Method as Promising Thermoelectric Materials
...
- papers: Investigating thermoelectric properties of doped polyaniline nanowires | Anisotropic heat conduction in the metal organic framework perovskites [C(NH2)3]X(HCOO)3 (X = Cu, Zn) | Large magnetic heat transport in a Haldane chain material Ni(C3H10N2)2NO2ClO4
...
- papers: Low temperature densification mechanism and properties of Ta1-Hf C solid solutions with decarbonization and phase transition of Cr3C2 | Effect of hot rolling and annealing on the mechanical properties and thermal conductivity of W-0.5wt.% TaC alloys
...
- papers: Electrical Properties of Nonstoichiometric Thorium Carbides | Etude de la structure electronique des carbures de thorium, d'uranium et de plutonium
...
- papers: Enhanced electronic correlation and thermoelectric response by Cu-doping in Ca3Co4O9 single crystals | Double Modulation and Microstructure of the Thermoelectric Misfit Compound [Ca2-yLnyCu0.7+yCo1.3-yO4][CoO2]b1/b2(Ln = Pr, Y and 0 ≤y≤ 1/3) | Development of new-type cobalt oxide thermoelectric materials
...
- papers: The effect of Mn substitution on thermoelectric properties of Ca3MnxCo4−xO9 at low temperatures | Thermoelectric Properties of Ca3Co2−xMnxO6 (x = 0.05, 0.2, 0.5, 0.75, and 1)
...
- papers: Novel thermoelectric properties of complex transition-metal oxides | Effect of Ca substitution by Sr on the thermoelectric properties of Ca3Co4O9 ceramics | Phase compatibility and thermoelectric properties of compounds in the Sr–Ca–Co–O system
...
- papers: Alleviated surface calcium segregation and improved electrocatalytic properties of La0.3Ca0.7Fe0.7Cr0.3O3-δ cathode: A demonstration of A-site deficiency effect | Evaluation of La 0.3 Ca 0.7 Fe 1−y Cr y O 3−δ (y = 0.1–0.3) cathodes for intermediate temperature solid oxide fuel cells | Relative content of the Cr4+ ion and electrical conductivity of La0.75Ca0.25Cr0.75Fe0.25O3
...
- papers: Substitution effect on the thermoelectric properties of alkaline earth titanate | Thermoelectric Properties of Lanthanum-Doped Europium Titanate | Band filling dependence of the electrical transport of Nd1−xAxTiO3 (A=Ca, Sr and Ba)
...
- papers: Thermophysical properties of BaUO3 | CaMn Zr(1-)O3: A novel NTC thermo-sensitive ceramic for applications in a wide temperature range | Vacancy defects reducing the accuracy and reliability of NTC sensors
...
- papers: A2Cu3In3Te8 (A = Cd, Zn, Mn, Mg): A Type of Thermoelectric Material with Complex Diamond-like Structure and Low Lattice Thermal Conductivities | Embedded in-situ nanodomains from chemical composition fluctuation in thermoelectric A2Cu3In3Te8 (A = Zn, Cd)
...
- papers: Thermoelectric properties of YbxEu1−xCd2Sb2 | High Seebeck Coefficient and Unusually Low Thermal Conductivity Near Ambient Temperatures in Layered Compound Yb2–xEuxCdSb2 | Synthesis, Characterization, and Low Temperature Transport Properties of Eu<sub>11–<i>x</i></sub>Yb<sub><i>x</i></sub>Cd<sub>6</sub>Sb<sub>12</sub> Solid-Solution Zintl Phases
...
- papers: Structural, magnetic, electrical and thermal transport properties in two-dimensional perovskite Sr1.05Ln0.95CoO4(Ln = La, Ce and Nd) compounds | Studies of structural, magnetic, electrical and thermal properties in layered perovskite cobaltite SrLnCoO4 (Ln = La, Ce, Pr, Nd, Eu, Gd and Tb) | Highly conducting perovskite structured (M-SrCoFe-O3-δ, M = Ce, Ba) cathode for solid oxide fuel cell
...
- papers: Electronic Transport and Thermoelectric Properties of p-Type Nd z Fe4−x Co x Sb12 Skutterudites | Super-rapid Preparation of Nanostructured Nd x Fe3CoSb12 Compounds and Their Improved Thermoelectric Performance
...
- papers: An Alternative Approach to Improve the Thermoelectric Properties of Half-Heusler Compounds | Enhanced thermoelectric performance in Ti(Fe, Co, Ni)Sb pseudo-ternary Half-Heusler alloys
...
- papers: Effect of ruthenium substitution in layered sodium cobaltate NaxCoO2: Synthesis, structural and physical properties | Magnetic and thermoelectric properties of NaCo2−xMxO4 (M = Mn, Ru)
...
- papers: High temperature thermoelectric properties of CoTiSb half-Heusler compounds | n-Type TaCoSn-Based Half-Heuslers as Promising Thermoelectric Materials
...
- papers: Vacancy site occupation by Co and Ir in half-Heusler ZrNiSn and conversion of the thermoelectric properties from n-type to p-type | Effect of Transition Element Substitution on the p-type Thermoelectric Properties of ZrNiSn-based Half-Heusler Compounds | Ordered Structures and Thermoelectric Properties of MNiSn (M = Ti, Zr, Hf)-Based Half-Heusler Compounds Affected by Close Relationship with Heusler Compounds
...
- papers: CuCrSe2: a high performance phonon glass and electron crystal thermoelectric material | Thermoelectric power of CuCrxVySe4 p-type spinel semiconductors | CuCrSe2\n Ternary Chromium Chalcogenide: Facile Fabrication, Doping and Thermoelectric Properties
...
- papers: Heavy fermion and Kondo lattice behavior in the itinerant ferromagnet CeCrGe3 | Ferromagnetic Quantum Critical Point Avoided by the Appearance of Another Magnetic Phase inLaCrGe3under Pressure
...
- papers: Structural and electrical properties of Cr1−xRuxSb2
...
- papers: Specific heat, susceptibility, magnetotransport and thermoelectric power of the Kondo alloys (Ce1 xLax)Cu5In | Thermpower of Ce x Y1?x InCu2 and CeInCu y Ag2?y | Electrical resistivity, magnetic properties and thermoelectric power factor of the polycrystalline compound CeCu4In: Effect of La dilution
...
- papers: Point contact spectra and transport properties of the dense Kondo substance CexLa1-xCu6 | Heavy fermion state in CeCu6 | Evidence for superconductivity inLa2CuO4
...
- papers: A new wide band gap thermoelectric quaternary selenide Cu2MgSnSe4
...
- papers: Thermoelectric Properties of Chevrel-Phase Sulfides M x Mo6S8 (M: Cr, Mn, Fe, Ni) | Preparation and Thermoelectric Properties of Chevrel-Phase Cu<I><SUB>x</SUB></I>Mo<SUB>6</SUB>S<SUB>8</SUB> (2.0&le;<I>x</I>&le;4.0) | Thermoelectric performance of Cu-doped MoS2 layered nanosheets for low grade waste heat recovery
...
- papers: Thermoelectric properties of Cu‐doped dysprosium sesquisulfide
...
- papers: Thermoelectric and thermophysical properties of ErPdX (X=Sb and Bi) half-Heusler compounds | Physical properties of rare-earth-based Heusler phases REPdZ and REPd/sub 2/Z (Z = Sb,Bi) | High-temperature Hall measurements of lanthanide based ternary intermetallics
...
- papers: Reproducibilities of Some Physical Properties of MgF2
...
- papers: Design of High‐Performance Disordered Half‐Heusler Thermoelectric Materials Using 18‐Electron Rule | Enhanced Thermoelectric Properties in p‐Type Double Half‐Heusler Ti<sub>2−<i>y</i></sub>Hf<sub><i>y</i></sub>FeNiSb<sub>2−<i>x</i></sub>Sn<sub><i>x</i></sub> Compounds | Enhanced thermoelectric performance in Ti(Fe, Co, Ni)Sb pseudo-ternary Half-Heusler alloys
...
- papers: Optimizing the thermoelectric performance of FeVSb half-Heusler compound via Hf–Ti double doping | Effects of spark plasma sintering on enhancing the thermoelectric performance of Hf–Ti doped VFeSb half-Heusler alloys | Transport and thermoelectric properties of Nb-doped FeV0.64Hf0.16Ti0.2Sb half-Heusler alloys synthesized by two ball milling regimes
...
- papers: Skutterudite Unicouple Characterization for Energy Harvesting Applications | High-temperature electrical and thermal transport properties of fully filled skutterudites RFe4Sb12 (R = Ca, Sr, Ba, La, Ce, Pr, Nd, Eu, and Yb) | Electronic Transport and Thermoelectric Properties of p-Type Nd z Fe4−x Co x Sb12 Skutterudites
...
- papers: X-ray diffraction characterization and electrical properties of TlIn1 − x Ga x Te2 crystals
...
- papers: Investigations on the thermal and piezoelectric properties of fresnoite Ba2TiSi2O8 single crystals | Analysis of the microstructure and physical properties of La 0.85 Sr 0.15 Ga 0.8 Mg 0.2 O 2.825 and Ce 0.85 Sm 0.15 O 1.925 composite electrolytes used in solid oxide fuel cells
...
- papers: Enhanced hole concentration through Ga doping and excess of Mg and thermoelectric properties of p-type Mg2(1+z)(Si0.3Sn0.7)1−yGay
