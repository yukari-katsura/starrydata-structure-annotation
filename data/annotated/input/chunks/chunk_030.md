...
- papers: Pressure cycling of InN to 20 GPa: In situ transport properties and amorphization | Advantage of In- over N-polarity for disclosure of p-type conduction in InN:Mg
...
- papers: Phase stability, microstructure, and dielectric properties of quaternary oxides In<sub>12</sub>\nTi<sub>10</sub>\nA<sub>2</sub>\nBO<sub>42</sub>\n (A: Ga or Al; B: Mg or Zn)
...
- papers: Thermoelectric properties of bipolar diffusion effect on In4Se3−xTex compounds | Improvement in Thermoelectric Properties by Tailoring at In and Te Site in In2Te5 | Thermoelectric Properties of Spark Plasma-Sintered In4Se3-In4Te3
...
- papers: Thermal conductivity across the metal-insulator transition in the single-crystalline hyperkagome antiferromagnetNa3+xIr3O8
...
- papers: Vacancy site occupation by Co and Ir in half-Heusler ZrNiSn and conversion of the thermoelectric properties from n-type to p-type | Ordered Structures and Thermoelectric Properties of MNiSn (M = Ti, Zr, Hf)-Based Half-Heusler Compounds Affected by Close Relationship with Heusler Compounds
...
- papers: Enhanced Electron Correlation and Significantly Suppressed Thermal Conductivity in Dirac Nodal‐Line Metal Nanowires by Chemical Doping

## Ir-Ru-Se
- rank 1458 | 4 samples | 1 papers | 1 compositions
- compositions: Ru0.8Ir0.2Se2 (4)
- measured range: 10-301 K (5th-95th pct of 4 curves)
- papers: Enhanced thermoelectric power and electronic correlations in RuSe2
...
- papers: Boosting the Seebeck Coefficient for Organic Coordination Polymers: Role of Doping-Induced Polaron Band Formation
...
- papers: Nature of correlated polaron hopping mechanism in A-site cation disorder Nd0.7−xLaxSr0.3MnO3 (x = 0.0, 0.1, 0.2 and 0.3) manganites | X-ray diffraction, magnetic and electrical properties in the manganites (La1−xNdx)0.7Sr0.3MnO3 | Effect of annealing in reduced oxygen pressure on the electrical transport properties of epitaxial thin film and bulk (La1−xNdx)0.7Sr0.3MnO3
...
- papers: Roles of spin fluctuations and rattling in magnetic and thermoelectric properties of AT4Sb12 (A=Ca, Sr, Ba, La; T=Fe, Ru, Os) | Transport properties in the filled-skutterudite compounds RERu4Sb12 (RE La, Ce, Pr and Nd); an exotic heavy fermion semimetal CeRu4Sb12 | Unusual behavior in the heavy Fermion semi-metal CeRu4Sb12
...
- papers: Optimizing Thermoelectric Efficiency in La3−xTe4via Yb Substitution
...
- papers: Porosity dependence on thermal diffusivity and thermal conductivity of lithium oxide Li2O from 200 to 900°C
...
- papers: High-Performance p-Type Magnesium Silicon Thermoelectrics | Thermoelectric Hexagonal A-Mg-Si with A = Sr and Ba Zintl Phases
...
- papers: Growth of large-grain R-Mg-Zn quasicrystals from the ternary melt (R = Y, Er, Ho, Dy and Tb) | Magnetic and transport properties of single-grainR−Mg−Znicosahedral quasicrystals [R=Y,(Y1−xGdx),(Y1−xTbx),Tb, Dy, Ho, and Er]
...
- papers: Thermoelectric behaviour of p- and n- type Ti-Ni-Sn half Heusler alloy variants and their amorphous equivalents | Optimized thermoelectric performance of the n-type half-Heusler material TiNiSn by substitution and addition of Mn
...
- papers: Thermopower studies of Pr0.67D0.33MnO3manganite system | Variation of magnetic and transport properties in magnetoresistive oxides La-ln-Pb-Mn-O (Ln=Pr, Nd, Dy, and Y)
...
- papers: Facile Route to High-Performance SnTe-Based Thermoelectric Materials: Synergistic Regulation of Electrical and Thermal Transport by In Situ Chemical Reactions
...
- papers: Effect of the Al-doping on the electrical and thermoelectric response of TbMnO3 polycrystalline samples: Evidence of polaronic transport
...
- papers: Sintering characteristics and thermoelectric properties of Mn&ndash;Al co-doped ZnO ceramics | An electron paramagnetic resonance study of n-type Zn1−xMnxO: A diluted magnetic semiconductor
...
- papers: Thermoelectric properties of Pb0.75−xMnxSn0.25Te alloys with variable manganese content | Enhanced Thermoelectric Properties of Sn0.8Pb0.2Te Alloy by Mn Substitution
...
- papers: Thermophysical properties of Mo–Ru–Rh–Pd alloys
...
- papers: Thermoelectric and structural properties of a new Chevrel phase: Ti0.3Mo5RuSe8 | Thermoelectric properties of Mo/sub 6/Se/sub 8/-based chevrel phase with semiconducting properties | Thermoelectric properties of Mo3Te4
...
- papers: Vacancy filling effect in thermoelectric NbO | Enhanced thermoelectric performance of amorphous Nb based oxynitrides
...
- papers: Enhanced thermoelectric performance of amorphous Nb based oxynitrides
...
- papers: Thermoelectric properties of amorphous ZnOxNy thin films at room temperature
...
- papers: Conduction mechanism in polycrystalline Na1−xSrxNbO3 niobium bronzes
...
- papers: Thermoelectrics with Earth Abundant Elements: High Performance p-type PbS Nanostructured with SrS and CaS
...
- papers: Electrical transport properties of NbSi<sub>2</sub>thin films
...
- papers: Molecular beam epitaxy of Nd2PdO4 thin           films
...
- papers: Crystal Structure and Thermoelectric Transport Properties of As-Doped Layered Pnictogen Oxyselenides NdO0.8F0.2Sb1−xAsxSe2
...
- papers: Band filling dependence of the electrical transport of Nd1−xAxTiO3 (A=Ca, Sr and Ba) | Neodymium-Strontium Titanate: A New Ceramic for an Old Problem | Ba6−3x Nd8+2x Ti18O54 Tungsten Bronze: A New High-Temperature n-Type Oxide Thermoelectric
...
- papers: Thermoelectric properties of polycrystalline NiSi3P4
...
- papers: Electronic states of perovskite-type and systems with a metal - insulator transition | A highly active and stable cathode for oxygen reduction in intermediate-temperature solid oxide fuel cells
...
- papers: Electrical and thermal conductivities of rare-earth A2Zr2O7 (A = Pr, Nd, Sm, Gd, and Er) | Thermal and oxygen transport properties of complex pyrochlore RE2InTaO7 for thermal barrier coating applications
...
- papers: Synthesis and thermoelectric properties of the novel A-site deficient Zn0.5Rh2O4 compound | Mg substitution effects of new thermoelectric Rh oxides
...
- papers: High-pressure synthesis, crystal and electronic structures of a new scandium tungstate, Sc0.67WO4
...
- papers: Transport properties of SmO | Samarium monoxide epitaxial thin film as a possible heavy-fermion compound
...
- papers: A self-forming nanocomposite concept for ZnO-based thermoelectrics
...
- papers: Low thermal conductivity in nanocrystalline Zn 3 P 2 | Electrical and thermoelectrical properties of Zn3P2films grown by the hot wall epitaxy technique
...
- papers: Thermal conductivity, electrical resistivity, and thermoelectric power of Pb from 260 to 550 K | Thin gold wires as reference for thermoelectric power measurements of small samples from 1.3 K to 350 K | Heavy hole effect on the thermoelectric properties of highly doped p-type lead telluride
...
- papers: Thermoelectrical properties of the compounds ScMVIIISb and YMVIIISb (MVIII   Ni, Pd, Pt) | Physical properties of rare-earth-based Heusler phases REPdZ and REPd/sub 2/Z (Z = Sb,Bi) | Magnetic and transport properties of the rare-earth-based Heusler phasesRPdZandRPd2Z(Z=Sb,Bi)
...
- papers: Thermoelectric properties of Mn-doped Ru/sub 2/Si/sub 3/ | Floating zone growth and characterization of semiconducting Ru2Si3 single crystals | A promising new thermoelectric material: Ruthenium silicide
