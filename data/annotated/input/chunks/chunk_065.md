...
- papers: Phase Characterization, Thermal Stability, High-Temperature Transport Properties, and Electronic Structure of Rare-Earth Zintl Phosphides Eu3M2P4(M = Ga, In)

## Eu-Gd-S-Sm
- rank 3202 | 1 samples | 1 papers | 1 compositions
- compositions: SmEuGdS4 (1)
- measured range: 302-934 K (5th-95th pct of 2 curves)
- papers: Synthesis of multinary rare-earth sulfides PrGdS3, NdGdS3, and SmEuGdS4, and investigation of their thermoelectric properties
...
- papers: Thermoelectric Properties of Valence-Fluctuating Eu Compound with a Clathrate-Like Structure, Eu3Pd20Ge6
...
- papers: Valence effect on the thermopower of Eu systems
...
- papers: Resistivity and Hall Effect of EuS in Fields up to 140 kOe
...
- papers: Crystal Cluster Growth and Physical Properties of the EuSbSe3and EuBiSe3Phases
...
- papers: Synthesis, structure and properties of the new layered manganese oxyselenide Sr2F2Mn2Se2O

## F-O-Ru-Sr
- rank 3216 | 1 samples | 1 papers | 1 compositions
- compositions: Sr2RuO3F (1)
- measured range: 21-297 K (5th-95th pct of 1 curves)
- papers: Topotactic fluorination of perovskite strontium ruthenate thin films using polyvinylidene fluoride
...
- papers: Single crystal data for “TlOF” and Tl2O3

## F-Sb-Sr-Zn
- rank 3218 | 1 samples | 1 papers | 1 compositions
- compositions: SrFZnSb (1)
- measured range: 323-754 K (5th-95th pct of 5 curves)
- papers: Thermoelectric properties and thermal expansion of quaternary layered compound SrFZnSb

## Fe-Ga-Ge-V
- rank 3219 | 1 samples | 1 papers | 1 compositions
- compositions: Fe2VGa0.8Ge0.2 (1)
- measured range: 12-297 K (5th-95th pct of 4 curves)
- papers: Effects of Ge substitution on the thermoelectric properties and pseudogap characteristics of Fe2VGa
...
- papers: CeFeGe3: A concentrated Kondo compound with a stable valency and high Kondo temperature
...
- papers: Thermal transport properties of magnetic refrigerants La(FexSi1−x)13 and their hydrides, and Gd5Si2Ge2 and MnAs
...
- papers: New p- and n-type skutterudites with ZT>1 and nearly identical thermal expansion and mechanical properties
...
- papers: Effects of Ti and Sn Substitutions on Magnetic and Transport Properties of the TiFe2Sn Full Heusler Compound
...
- papers: La-induced changes in the magnetic and electronic properties ofSr2−xLaxFeMoO6
...
- papers: Evaluation of La<sub><i>x</i></sub>Sr<sub>1−<i>x</i></sub>Zn<sub><i>y</i></sub>Fe<sub>1−<i>y</i></sub>O<sub>3−<i>δ</i></sub>(<i>x</i>= 0.54, 0.8,<i>y</i>= 0.2, 0.4) as a promising cobalt free composite cathode for SOFCs
...
- papers: Thermoelectric performance of polyparaphenylene/Li0·5Ni0·5Fe2O4nanocomposites
...
- papers: Electron doping of Sr<sub>2</sub>FeMoO<sub>6−δ</sub> as high performance anode materials for solid oxide fuel cells
...
- papers: Magnetic properties and electronic state of Mo<sub> <i>x</i> </sub>Fe<sub>3−<i>x</i> </sub>O<sub>4</sub> ferrites

## Fe-Mo-O-Pb
- rank 3234 | 1 samples | 1 papers | 1 compositions
- compositions: Pb2FeMoO6 (1)
- measured range: 11-392 K (5th-95th pct of 1 curves)
- papers: Magnetic properties and magnetoresistance effect of Pb<sub>2</sub>FeMoO<sub>6</sub>
...
- papers: Studies of electrical transport properties of Sr2Fe(Mo, V)O6 compound
...
- papers: Tuning of the electronic and phononic properties of NbFeSb half-Heusler compound by Sn/Hf co-doping
...
- papers: Nickel-Containing Perovskites, PrNi0.4Fe0.6O3–δ and PrNi0.4Co0.6O3–δ, as Potential Electrodes for Protonic Ceramic Electrochemical Cells
...
- papers: Reduced thermal conductivity in nanolamellar composite comprising half-Heusler and NiAs-type phases
...
- papers: Thermoelectric properties of Tl-filled Co-free p-type skutterudites: Tlx(Fe,Ni)4Sb12
...
- papers: Observation of novel charge ordering and spin reorientation in perovskite oxide PbFeO3
...
- papers: Physico-chemical properties of V1-XFeX O2 and FeV2O6
...
- papers: Doubled Thermoelectric Figure of Merit in p-Type β-FeSi2 via Synergistically Optimizing Electrical and Thermal Transports
...
- papers: Thermoelectric performance of p-type skutterudites YbxFe4−yPtySb12 (0.8 ≤ x ≤ 1, y = 1 and 0.5)
...
- papers: The Influence of Sn Additions on the Thermoelectric and Transport Properties of FeSb2Te-based Ternary Skutterudites
