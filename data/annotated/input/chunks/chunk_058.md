...
- papers: Enhanced thermoelectric properties of Ca1-x Sm x Mn1-y W y O3-δ for power generation
...
- papers: Role of Tetravalent Ion in Metal–Insulator Transition in (La0.1Ca0.9)(Mn1−Ti )O3
...
- papers: High-Pressure Synthesis of 5d Cubic Perovskite BaOsO<sub>3</sub> at 17 GPa: Ferromagnetic Evolution over 3d to 5d Series
...
- papers: Structural and electronic properties of pyrochlore-type<mml:math xmlns:mml=\"http://www.w3.org/1998/Math/MathML\" display=\"inline\"><mml:mrow><mml:msub><mml:mi>A</mml:mi><mml:mrow><mml:mn>2</mml:mn></mml:mrow></mml:msub></mml:mrow></mml:math>Re<mml:math xmlns:mml=\"http://www.w3.org/1998/Math/MathML\" display=\"inline\"><mml:mrow><mml:msub><mml:mrow /><mml:mrow><mml:mn>2</mml:mn></mml:mrow></mml:msub></mml:mrow></mml:math>O<mml:math xmlns:mml=\"http://www.w3.org/1998/Math/MathML\" display=\"inline\"><mml:mrow><mml:msub><mml:mrow /><mml:mrow><mml:mn>7</mml:mn></mml:mrow></mml:msub></mml:mrow></mml:math>(<mml:math xmlns:mml=\"http://www.w3.org/1998/Math/MathML\" display=\"inline\"><mml:mrow><mml:mi>A</mml:mi><mml:mo>=</mml:mo><mml:mtext>Ca</mml:mtext></mml:mrow></mml:math>, Cd, and Pb)
...
- papers: High performance thermoelectrics from earth-abundant materials: Enhanced figure of merit in PbS through nanostructuring grain size
...
- papers: Enhanced Thermoelectric Performance of Cu2CdSnSe4 by Mn Doping: Experimental and First Principles Studies
...
- papers: Revisiting the heavy-fermion compound \n<mml:math xmlns:mml=\"http://www.w3.org/1998/Math/MathML\"><mml:msub><mml:mi>YbCdCu</mml:mi><mml:mn>4</mml:mn></mml:msub></mml:math>\n: Kondo temperature and the ground-state degeneracy
...
- papers: Low-temperature structural stability of Cd6M(M = Ho, Er, Tm and Lu) cubic crystalline approximants
...
- papers: Structural analysis, growth and characterization of cadmium gallium telluride (Cd0.89Ga0.11Te) thermoelectric semiconductor single crystals
...
- papers: Preparation, electrical properties and optical characterization of Cd2SnO4 and CdIn2O4 thin films as transparent and conductive coatings
...
- papers: Tuning of the microstructure and thermoelectric properties of CdO ceramics by Mg substituting
...
- papers: Fluctuation effects on the physical properties of Cd<sub>2</sub>Re<sub>2</sub>O<sub>7</sub>near 200 K
...
- papers: DC galvanomagnetic and thermoelectric effects in an undoped single crystal of n-type CdSe optimally annealed in molten cd at high temperatures
...
- papers: Novel phase transition in the Cd6M intermetallics
...
- papers: Transport properties in CeCo2 single crystal
...
- papers: Thermoelectric properties of rare-earth alloys
...
- papers: Highly conducting perovskite structured (M-SrCoFe-O3-δ, M = Ce, Ba) cathode for solid oxide fuel cell
...
- papers: Influence of Ce–H bonding on the physical properties of the hydrides CeCoSiH1.0 and CeCoGeH1.0
...
- papers: Thermoelectric properties of the intermediate valent cerium intermetallic Ce2Ni3Si5 doped with Pd, Co, and Cu
...
- papers: Thermoelectric and magnetic properties of CeRh1$minus;xMxSn (M=Co, Ni, Ru)

## Ce-Co-Ru-Sn
- rank 2892 | 1 samples | 1 papers | 1 compositions
- compositions: Ce3CoRu3Sn13 (1)
- measured range: 13-298 K (5th-95th pct of 3 curves)
- papers: Doping effect on the electronic structure and thermodynamic properties in \n<mml:math xmlns:mml=\"http://www.w3.org/1998/Math/MathML\"><mml:mrow><mml:msub><mml:mi>Ce</mml:mi><mml:mn>3</mml:mn></mml:msub><mml:msub><mml:mi>Ru</mml:mi><mml:mn>4</mml:mn></mml:msub><mml:msub><mml:mi>Sn</mml:mi><mml:mn>13</mml:mn></mml:msub></mml:mrow></mml:math>
...
- papers: Heavy fermion and Kondo lattice behavior in the itinerant ferromagnet CeCrGe3
...
- papers: Thermoelectric power in (, Ni; , Ga) compounds

## Ce-Cu-La-Sn
- rank 2897 | 1 samples | 1 papers | 1 compositions
- compositions: CeLa4CuSn3 (1)
- measured range: 13-281 K (5th-95th pct of 2 curves)
- papers: Formation of Heavy-fermion State in Ce5-xLaxCuSn3

## Ce-Ga-H-Ir
- rank 2898 | 1 samples | 1 papers | 1 compositions
- compositions: CeIrGaH1.8 (1)
- measured range: 12-298 K (5th-95th pct of 1 curves)
- papers: Hydrogenation of the Ce(Rh1-xIrx)Ga System:  Occurrence of Antiferromagnetic Ordering in the Hydrides Ce(Rh1-xIrx)GaH1.8
...
- papers: From intermediate valence to magnetic behavior without long-range order by hydrogenation of the ternary gallide CeNiGa
