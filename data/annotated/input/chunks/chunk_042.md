...
- papers: High-temperature thermoelectric properties of Ca0.9Y0.1Mn1−x Fe x O3 (0 ≤ x ≤ 0.25) | Transport and magnetic properties of Fe doped CaMnO<sub>3</sub>
...
- papers: Effect of the A Cation Size Disorder on the Properties of an Iron Perovskite Series for Their Use as Cathodes for SOFCs | Synthesis and electrical properties of Ln0.6Ca0.4FeO3−δ (LnPr, Nd, Sm) as cathode materials for IT-SOFC
...
- papers: Thermoelectric Properties of Ca1−xGdxMnO3−δ(0.00, 0.02, and 0.05) Systems | The effect of Gd-doping on the charge ordering state of Bi0.3−xGdxCa0.7MnO3 (0≤x≤0.30)
...
- papers: Phase relation and thermoelectric properties of the ternary lanthanum chalcogenide system La–A–S (A=Ca, Ba)
...
- papers: Specific heat and thermoelectric power of Mott transition compound Y0.61Ca0.39TiO3
...
- papers: Large magnetoresistance and thermoelectric properties of a quasi-skutterudite Ca\n                    <sub>3</sub>\n                    Pt\n                    <sub>4</sub>\n                    Sn\n                    <sub>13</sub>\n                    single crystal
...
- papers: Effect of manganese doping on the thermoelectric properties of Zintl phase EuCd2Sb2
...
- papers: Thermoelectric power and electrical conductivity of cadmium-substituted manganese ferrites
...
- papers: Electrical and optical properties of conducting N-type Cd2SnO4 thin films | Preparation, electrical properties and optical characterization of Cd2SnO4 and CdIn2O4 thin films as transparent and conductive coatings
...
- papers: Enhanced thermopower in rock-salt SnTe–CdTe from band convergence
...
- papers: Electrical and thermoelectric transport properties of RZn and RCd compounds (R = Tb, Gd, Nd, Pr) | Long-range magnetic order in the quasicrystalline approximant<mml:math xmlns:mml=\"http://www.w3.org/1998/Math/MathML\" display=\"inline\"><mml:mrow><mml:msub><mml:mrow><mml:mtext>Cd</mml:mtext></mml:mrow><mml:mn>6</mml:mn></mml:msub><mml:mtext>Tb</mml:mtext></mml:mrow></mml:math>
...
- papers: Thermal conductivity, electrical conductivity, and thermoelectric properties of CdTe and Cd0.8Zn0.2Te crystals between room temperature and 780oC

## Ce-Co-In-Rh
- rank 2065 | 2 samples | 1 papers | 1 compositions
- compositions: (CeCoIn5)5(CeRhIn5)5 (2)
- papers: Tuning the Pairing Interaction in a \nd\n-Wave Superconductor by Paramagnons Injected through Interfaces
...
- papers: Thermoelectric Properties of Heavy Fermion Compound Ce3Co4Sn13
...
- papers: Magnetothermopower and magnetoresistivity of RuSr2Gd2−xCexCu2O10+δ (x=0.6,1.0)
...
- papers: Semiconducting behaviour of Ce3 Cu3 Sb4 revisited
...
- papers: Thermoelectricity and localized f-band control by dp-hybridization on the Ce1−xCuxSe2 compounds
...
- papers: Formation of Heavy-fermion State in Ce5-xLaxCuSn3 | Magnetic, electronic transport and thermodynamic properties of Ce5CuSn3
...
- papers: Peculiarities of the intermediate valence state of Ce in CeM2Si2 (M=Fe, Co, Ni) compounds | Thermoelectric power in compounds with an intermediate valence of Ce: phenomenological description
...
- papers: Ultralow thermal conductivity of cerium-doped Nd2Zr2O7 over a wide doping range
...
- papers: Electronic properties of CeRh1−xGexIn; evolution from an intermediate-valence to a localized 4f-state
...
- papers: Thermoelectric properties of the solid solutions based on ThSi2-type CeSi2 compound
...
- papers: [] | Study on the structural and electrical properties of Sr1−xCexMnO3−α (x = 0.1, 0.3) perovskite oxide
...
- measured range: 11-299 K (5th-95th pct of 2 curves)
- papers: Thermoelectric power behaviour of CeRh2−xNixSi2 alloys
...
- papers: Ce1−x\n                            Sm\n                x\n              O2−x/2—A novel type of ceramic material for thermal barrier coatings
...
- papers: Thermal and mechanical properties of ZrO2-CeO2 plasma-sprayed coatings | Ultralow thermal conductivity of cerium-doped Nd2Zr2O7 over a wide doping range
...
- papers: Evidence of the different valence states in the C14 and C15 phases CeOs2
...
- papers: Thermoelectric power of Ce(Pb1−xSnx)3 | Seebeck coefficient of heavy fermion compounds
...
- papers: Crossover in charge transport of CeM2 | Magnetic and electrical properties of the intermetallic compounds R7Rh3 (R=La, Ce, Pr and Nd)
...
- papers: Thermopower and resistivity of CeRhSb and CePtSn | Thermoelectric power of Ce-based Kondo alloys
...
- papers: The thermoelectric power of someThCe alloys | Comments upon ?the thermoelectric power of someThCe alloys? and an alternate suggestion
...
- papers: Calcium- and Cobalt-Doped Yttrium Chromites as an Interconnect Material for Solid Oxide Fuel Cells
...
- papers: Thermoelectric power studies of Cu–Co ferrites
...
- papers: Enhancing the thermoelectric performance of a p-type half-Heusler alloy, HfCoSb by incorporation of a band-matched chalcogenide, Cu<sub>2</sub>Te
...
- papers: EuCo2P2: A model molecular-field helical Heisenberg antiferromagnet
...
- papers: Structural and thermoelectric properties of TMGa3(TM = Fe, Co) thin films | Thermoelectric performance of intermetallic FeGa3 with Co doping
...
- papers: Improved thermoelectric properties in heavily doped FeGa3
...
- papers: Thermoelectric power studies of Co–Ge ferrites
...
- papers: Enhanced thermoelectric performance in Ti(Fe, Co, Ni)Sb pseudo-ternary Half-Heusler alloys
...
- papers: Thermoelectric Properties of Sintered (MnyCo1-y) Fe2O4
...
- papers: Effects of cobalt and iron proportions in Pr0.4Sr0.6Co0.9-xFexNb0.1O3-δ electrode material for symmetric solid oxide fuel cells
