...
- papers: Thermal conductivity of UO2 and PuO2 from first-principles
...
- papers: High-temperature thermoelectric properties of Sr2RuYO6 and Sr2RuErO6 double perovskites influenced by structure and microstructure
...
- papers: Neodymium-Strontium Titanate: A New Ceramic for an Old Problem
...
- papers: Tailored fabrication of a prospective acousto–optic crystal TiTe3O8 endowed with high performance
...
- papers: Vacuum sintering of novel transparent Tm2O3 ceramics: Effect of silica additive and thermal performance
...
- papers: Osmium disilicide: Preparation, crystal growth, and physical properties of a new semiconducting compound
...
- papers: Rb4Sn5P4Se20: A Semimetallic Selenophosphate
...
- papers: Highly Disordered Crystal Structure and Thermoelectric Properties of Sn3P4
...
- papers: Band Sharpening and Band Alignment Enable High Quality Factor to Enhance Thermoelectric Performance in n-Type PbS
...
- papers: Recent Advances of Layered Thermoelectric Materials
...
- papers: Tuning bands of PbSe for better thermoelectric efficiency
...
- papers: Phase equilibria in the Tl2Se-PbSe system and growth and properties of Tl4PbSe3 single crystals
...
- papers: Nanostructuring and High Thermoelectric Efficiency in p-Type Ag(Pb1 –ySny)mSbTe2 +m
...
- papers: Extensive studies of antiferromagneticPuPd2Sn
