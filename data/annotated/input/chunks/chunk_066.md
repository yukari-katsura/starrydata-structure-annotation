...
- papers: https://doi.org/10.1109/tmag.2018.2874631 (Magnetic and Thermoelectric Properties of Fe–Ti–Sn Alloys)
...
- papers: https://doi.org/10.1134/s1063782619060277 (Influence of V Doping on the Thermoelectric Properties of Fe2Ti1 –xVxS...)
...
- papers: https://doi.org/10.1063/1.4710350 (Enhancement in power factor values of Sn substituted Fe2 VAl Heusler a...)
...
- papers: https://doi.org/10.3327/taesj.j18.011 (Thermal and Mechanical Properties of Fe<sub>2</sub>Zr)
...
- papers: https://doi.org/10.1016/j.jallcom.2016.10.305 (Synthesis and thermoelectric properties of semiconducting germanium-ba...)
...
- papers: https://doi.org/10.1021/acs.inorgchem.0c01805 (Electron-Precise Semiconducting ReGa2Ge: Extending the IrIn3 Structure...)
...
- papers: https://doi.org/10.1021/je400882q (Thermophysical Properties of the Liquid Ga–In–Sn Eutectic Alloy)
...
- papers: https://doi.org/10.1103/physrevb.63.174414 (Conductivity and switching phenomena in Mn-doped perovskite single cry...)
...
- papers: https://doi.org/10.1039/c4ra02740j (Modified Bridgman growth and characterization of a novel mid-infrared ...)
...
- papers: https://doi.org/10.1038/srep34549 (Observation of orbital two-channel Kondo effect in a ferromagnetic L10...)
...
- papers: https://doi.org/10.1002/adma.201501970 (A Thermoelectric Zintl Phase Na2+xGa2+xSn4-xwith Disordered Na Atoms i...)
...
- papers: https://doi.org/10.1016/j.jallcom.2011.01.006 (Synthesis and high-temperature thermoelectric properties of Ni3GaSb an...)
...
- papers: https://doi.org/10.1103/physrevb.54.15330 (Hall effect and thermoelectric power in UNiGa)
...
- papers: https://doi.org/10.1103/physrevb.60.r8422 (Destruction of the Mott insulating ground state of<mml:math xmlns:mml=...)
...
- papers: https://doi.org/10.1021/acs.inorgchem.8b01109 (Ternary Suboxides Ti<sub>7</sub>Ga<sub>2</sub>O<sub>6</sub>, Ti<sub>3<...)
...
- papers: https://doi.org/10.1063/1.1803947 (Thermoelectric properties of semiconductorlike intermetallic compounds...)
...
- papers: https://doi.org/10.1016/0022-3697(93)90218-g (Electrical resistivity, magnetic susceptibility and thermoelectric pow...)
...
- papers: https://doi.org/10.1016/j.intermet.2017.09.012 (Thermoelectric properties of Heusler-type Ru2VAl1−Ga  alloys)
...
- papers: https://doi.org/10.1016/j.jcrysgro.2013.05.008 (Influence of temperature on the thermal transport properties of a TlGa...)
...
- papers: https://doi.org/10.1016/j.jallcom.2006.09.166 (Structure and transport properties of new rare-earth gallium telluride...)
...
- papers: https://doi.org/10.1063/1.5140557 (Correlation transports at p-/n-types in electron metastable perovskite...)
...
- papers: https://doi.org/10.1007/s11664-011-1846-z (Thermoelectric Properties of TlGdQ2 (Q = Se, Te) and Tl9GdTe6)
...
- papers: https://doi.org/10.2320/jinstmet.j2014005 (Thermoelectric Properties of RE5X3(RE=Gd, La, X=Si, Ge))
...
- papers: https://doi.org/10.1126/sciadv.aay6407 (High mobility in a van der Waals layered antiferromagnetic metal)
...
- papers: https://doi.org/10.1016/0304-8853(82)90043-9 (Transport properties and ultrasonic propagation in single crystal Gd65...)
