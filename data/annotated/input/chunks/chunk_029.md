...
- papers: Phonon Scattering through a Local Anisotropic Structural Disorder in the Thermoelectric Solid Solution Cu2Zn1–xFexGeSe4
...
- papers: The Thermoelectric Properties and Solubility Limit of CuFeS2(1−x)Se2x
...
- papers: Thermoelectric properties of layered rare earth copper oxides | Thermoelectric power in Gd1.85−xPrxCe0.15CuO4 system | Thermophysical properties of layered rare earth copper oxides
...
- papers: Thermoelectric power in Gd1.85−xPrxCe0.15CuO4 system
...
- papers: Conducting glasses as new potential thermoelectric materials: the Cu–Ge–Te case | Carrier density control and enhanced thermoelectric performance of Bi and Cu           co-doped GeTe | Thermoelectric and mechanical properties of Ag and Cu doped (GeTe)0.96(Bi2Te3)0.04
...
- papers: Structure–property relationships along the Fe-substituted CuInS2 series: Tuning of thermoelectric and magnetic properties
...
- papers: Strategy to optimize the overall thermoelectric properties of SnTe via compositing with its property-counter CuInTe 2
...
- papers: Thermpower of Ce x Y1?x InCu2 and CeInCu y Ag2?y | Transport properties of RInCu4 with C15b-type structure

## Cu-Ir-Rh-S
- rank 1409 | 4 samples | 1 papers | 1 compositions
- compositions: CuIrRhS4 (4)
- measured range: 13-300 K (5th-95th pct of 9 curves)
- papers: Temperature dependence of thermodynamic and electrical properties of CuIrRhS 4
...
- papers: Transport mechanism in La1.85Sr0.15Cu1−xMgxO4 system
...
- papers: Thermoelectric properties of layered oxyselenides La1−xSrxCuOSe (x=0 to 0.2)
...
- papers: Enargite Cu\n            3\n            PS\n            4\n            : A Cu–S‐Based Thermoelectric Material with a Wurtzite‐Derivative Structure
...
- papers: The charge localization deteriorating the thermoelectric properties: The case of kiddcreekite-type Cu6WSnSe8
...
- papers: Thermoelectric Power and Electrical Resistivity of Dilute Alloys of Silicon in Copper, Nickel, and Iron | Transport properties of the<mml:math xmlns:mml=\"http://www.w3.org/1998/Math/MathML\" display=\"inline\"><mml:mrow><mml:msub><mml:mrow><mml:mi mathvariant=\"normal\">Ce</mml:mi></mml:mrow><mml:mrow><mml:mi>x</mml:mi></mml:mrow></mml:msub></mml:mrow><mml:mrow><mml:msub><mml:mrow><mml:mi mathvariant=\"normal\">La</mml:mi></mml:mrow><mml:mrow><mml:mn>1</mml:mn><mml:mi>−</mml:mi><mml:mi>x</mml:mi></mml:mrow></mml:msub></mml:mrow><mml:mrow><mml:msub><mml:mrow><mml:mi mathvariant=\"normal\">Cu</mml:mi></mml:mrow><mml:mrow><mml:mn>2.05</mml:mn></mml:mrow></mml:msub></mml:mrow><mml:mrow><mml:msub><mml:mrow><mml:mi mathvariant=\"normal\">Si</mml:mi></mml:mrow><mml:mrow><mml:mn>2</mml:mn></mml:mrow></mml:msub></mml:mrow></mml:math>heavy-fermion alloy system
...
- papers: Thermoelectric and Thermophysical Characteristics of Cu<SUB>2</SUB>Te-Tl<SUB>2</SUB>Te Pseudo Binary System | Thermoelectric properties of ternary copper thallium telluride: CuTl/sub 9/Te/sub 5/ | Thermoelectric Properties of TlCu3Te2 and TlCu2Te2
...
- papers: Thermoelectric power studies of erbium substituted Mn–Zn ferrites
...
- papers: A d-Band Electron Correlated Thermoelectric Thermistor Established in Metastable Perovskite Family of Rare-Earth Nickelates
...
- papers: Enhancement of thermoelectric performance of phase pure Zintl compounds Ca 1−x Yb x Zn 2 Sb 2 , Ca 1 −x Eu x Zn 2 Sb 2 , and Eu 1 −x Yb x Zn 2 Sb 2  by mechanical alloying and hot pressing | Thermoelectric properties of EuZn2Sb2 Zintl compounds: zT enhancement through Yb substitution for Eu
...
- papers: Thermoelectric power studies of gadolinium substituted Mn–Zn–Gd ferrites
...
- papers: Transport and thermoelectric properties of Hf-doped FeVSb half-Heusler alloys | Optimizing the thermoelectric performance of FeVSb half-Heusler compound via Hf–Ti double doping | Effects of spark plasma sintering on enhancing the thermoelectric performance of Hf–Ti doped VFeSb half-Heusler alloys
...
- papers: Thermal and mechanical properties of Yb&Mg co-doped InFeZnO4
...
- papers: Effect of oxygen vacancy on ferromagnetism and electric transport of bulk polycrystalline (In0.8Mo0.05Fe0.15)2O3
...
- papers: Electrical, Thermoelectric, and Structural Properties of La(M[sub x]Fe[sub 1−x])O[sub 3] (M=Mn, Ni, Cu) | Magnetic properties, resistivity and magnetoresistance effects of double perovskite La2Co1−xFexMnO6 | Assessment of LaM0.25Mn0.75O3- (M = Fe, Co, Ni, Cu) as promising cathode materials for intermediate-temperature solid oxide fuel cells
...
- papers: High-Temperature Thermoelectric Properties of Perovskite-Type Pr0.9Sr0.1Mn1−x Fe x O3 (0 ≤ x ≤ 1)
...
- papers: Thermoelectric Property of Nb-doped Sr2FeMoO6 Double Perovskite Oxide
...
- papers: Synthesis, crystal structure and thermoelectric properties of the ternary skutterudite Fe2Pd2Sb12
...
- papers: Correlated evolution of colossal thermoelectric effect and Kondo insulating behavior | Influence of Ru Substitution on the Thermoelectric Properties of Ce(Fe1-xRux)4Sb12Solid Solutions
...
- papers: Normal state above the upper critical field in \nFe1+yTe1−x(Se,S)x | Thermal Conductivity and Electrical Resistivity of FeTe1-xSx Sintered Samples
...
- papers: Synthesis and Structural Characterization of Sb-Doped TiFe2Sn Heusler Compounds | Thermoelectric properties of chemically substituted full-Heusler<mml:math xmlns:mml=\"http://www.w3.org/1998/Math/MathML\"><mml:mrow><mml:mi mathvariant=\"normal\">F</mml:mi><mml:msub><mml:mi mathvariant=\"normal\">e</mml:mi><mml:mn>2</mml:mn></mml:msub><mml:mi>TiS</mml:mi><mml:msub><mml:mi mathvariant=\"normal\">n</mml:mi><mml:mrow><mml:mn>1</mml:mn><mml:mtext>−</mml:mtext><mml:mi>x</mml:mi></mml:mrow></mml:msub><mml:mi mathvariant=\"normal\">S</mml:mi><mml:msub><mml:mi mathvariant=\"normal\">b</mml:mi><mml:mi>x</mml:mi></mml:msub><mml:mrow><mml:mo>(</mml:mo><mml:mrow><mml:mi>x</mml:mi><mml:mo>=</mml:mo><mml:mn>0</mml:mn><mml:mo>,</mml:mo><mml:mspace width=\"0.16em\" /><mml:mn>0.1</mml:mn><mml:mo>,</mml:mo><mml:mspace width=\"0.16em\" /><mml:mi>and</mml:mi><mml:mspace width=\"0.16em\" /><mml:mn>0.2</mml:mn></mml:mrow><mml:mo>)</mml:mo></mml:mrow></mml:mrow></mml:math>compounds | Origin of the magnetic ground state developed upon Si, Ge, and Sb-substitution at Sn site in Fe2TiSn
...
- papers: Discovery of TaFeSb-based half-Heuslers with high thermoelectric performance
...
- papers: Preparation and study of the thermoelectric properties of Fe2TiSn1–x\n                            Si\n                                x\n                             Heusler alloys
...
- papers: Preparation and thermoelectric properties of sintered Fe1−xCoxTe2 (0≤x≤0.4) | Magnetothermoelectric effects in <mml:math altimg=\"si8.gif\" overflow=\"scroll\" xmlns:xocs=\"http://www.elsevier.com/xml/xocs/dtd\" xmlns:xs=\"http://www.w3.org/2001/XMLSchema\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns=\"http://www.elsevier.com/xml/ja/dtd\" xmlns:ja=\"http://www.elsevier.com/xml/ja/dtd\" xmlns:mml=\"http://www.w3.org/1998/Math/MathML\" xmlns:tb=\"http://www.elsevier.com/xml/common/table/dtd\" xmlns:sb=\"http://www.elsevier.com/xml/common/struct-bib/dtd\" xmlns:ce=\"http://www.elsevier.com/xml/common/dtd\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" xmlns:cals=\"http://www.elsevier.com/xml/common/cals/dtd\"><mml:mrow><mml:msub><mml:mrow><mml:mtext>Fe</mml:mtext></mml:mrow><mml:mrow><mml:mn>1</mml:mn><mml:mo>+</mml:mo><mml:mi>d</mml:mi></mml:mrow></mml:msub><mml:msub><mml:mrow><mml:mtext>Te</mml:mtext></mml:mrow><mml:mrow><mml:mn>1</mml:mn><mml:mo>-</mml:mo><mml:mi>x</mml:mi></mml:mrow></mml:msub><mml:msub><mml:mrow><mml:mtext>Se</mml:mtext></mml:mrow><mml:mrow><mml:mi>x</mml:mi></mml:mrow></mml:msub></mml:mrow></mml:math> | Thermal Conductivity and Electrical Resistivity of FeTe1-xSx Sintered Samples
...
- papers: Enhancing the Thermoelectric Properties of Germanium Antimony Tellurides by Substitution with Selenium in Compounds GenSb2(Te1–xSex)n+3(0 ≤x≤ 0.5;n≥ 7)
...
- papers: Thermoelectric properties of Sr3GaSb3 – a chain-forming Zintl compound
...
- papers: Transport properties of RGa2 (R=La, Ce and Sm)
...
- papers: Preparation and Thermoelectric Properties of LaGd1+x S3 and SmGd1+x S3
...
- papers: Magnetoresistance behaviour and thermoelectric transport properties of Gd7T3 (T=Pd, Rh) single crystals
...
- papers: Tl2AXTe4(A = Cd, Hg, Mn; X = Ge, Sn):  Crystal Structure, Electronic Structure, and Thermoelectric Properties
...
- papers: Thermoelectric Properties Evolution of Spark Plasma Sintered (Ge0.6Pb0.3Sn0.1)Te Following a Spinodal Decomposition
...
- papers: Giant Seebeck effect in Ge-doped SnSe | Thermoelectric properties of GeSe
...
- papers: Galvanomagnetic and thermoelectric properties of HgSx Te1?x solid solutions | Semi-metals as potential thermoelectric materials
...
- papers: Beneficial influence of iodine substitution on the thermoelectric properties of Mo3Sb7
