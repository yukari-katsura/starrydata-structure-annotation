...
- sample form: Bulk (6); SingleCrystal (5); Polycrystal (2)
...
- sample form: Film (8); SingleCrystal (1)   <-- film/epitaxial samples present: a metastable polymorph may be reachable here that never forms in bulk
...
- sample form: Bulk (6); Polycrystal (3); SingleCrystal (2)
...
- sample form: Plate (6); SingleCrystal (4); Polycrystal (3); Bulk (1)
...
- sample form: Bulk (10); SingleCrystal (4)
...
- seed hypothesis (confirm): thcr2si2_122
- sample form: SingleCrystal (9); Rod (2); Polycrystal (1)
...
- seed hypothesis (confirm): solid_solution_alloy
- sample form: Ribbon (1); Composite (1)
...
- seed hypothesis (confirm): thcr2si2_122
- sample form: SingleCrystal (11); Bulk (1)
...
- sample form: SingleCrystal (5); OrientedBulk (4)
...
- sample form: Polycrystal (11); SingleCrystal (3)
