...
- sample form: Film (5)   <-- film/epitaxial samples present: a metastable polymorph may be reachable here that never forms in bulk
...
- sample form: Other (13); SingleCrystal (1)
...
- sample form: Bulk (10); OrientedBulk (1); Polycrystal (1)
...
- sample form: Bulk (12); Polycrystal (1)
...
- sample form: Film (13)   <-- film/epitaxial samples present: a metastable polymorph may be reachable here that never forms in bulk
...
- seed hypothesis (confirm): thcr2si2_122
- sample form: SingleCrystal (6); Bulk (1)
...
- sample form: Bulk (4); Polycrystal (3)
...
- sample form: Polycrystal (7); SingleCrystal (4)
...
- sample form: Bulk (11); SingleCrystal (1)
...
- sample form: Bulk (7); SingleCrystal (2)
