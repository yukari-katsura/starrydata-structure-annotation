...
- papers: Selective Charge Carrier Transport and Bipolar Conduction in an Inorganic/Organic Bulk-Phase Composite: Optimization for Low-Temperature Thermoelectric Performance
...
- papers: Materials design, synthesis, and transport properties of disordered rare-earth Zintl bismuthides with the <i>anti</i>-Th<sub>3</sub>P<sub>4</sub> structure type
...
- papers: Structural features and transport properties of iodine intercalated misfit layer [BiCaO/sub 2/]/sub 2/[CoO/sub 2/]/sub 1.69/ single crystals
...
- papers: Magneto-thermoelectric effects of the layered cobalt oxides
...
- papers: Synthesis and characterization of Er-substituted Bi-2223 H-Tc glass–ceramic superconductors
...
- papers: Thermoelectric power of Si-doped (Bi,Pb)SrCaCuO superconducting system
...
- papers: Effect of calcium doping on the electrocatalytic activity of the Bi<sub>1−<i>x</i></sub>Ca<sub><i>x</i></sub>FeO<sub>3−<i>δ</i></sub> oxygen electrode for solid oxide fuel cells
...
- papers: A new chalcogenide homologous series A2[M5+nSe9+n] (A = Rb, Cs; M = Bi, Ag, Cd)
...
- papers: Self-reorganization of CdTe nanoparticles into two-dimensional Bi2Te3/CdTe nanosheets and their thermoelectrical properties
...
- papers: Magnetic and magnetotransport properties of ThCr<sub>2</sub>Si<sub>2</sub>-type Ce<sub>2</sub>O<sub>2</sub>Bi composed of conducting Bi<sup>2−</sup> square net and magnetic Ce−O layer
...
- papers: Thermoelectric properties of Ce-doped n-type CexBi2 − xTe2.7Se0.3nanocomposites

## Bi-Ce-Te
- rank 2727 | 1 samples | 1 papers | 1 compositions
- compositions: Ce0.3Bi1.7Te3 (1)
- measured range: 303-533 K (5th-95th pct of 5 curves)
- papers: Preparation and thermoelectric properties of flower-like nanoparticles of Ce-Doped Bi2Te3
...
- papers: Multiple Converged Conduction Bands in K2Bi8Se13: A Promising Thermoelectric Material with Extremely Low Thermal Conductivity
...
- papers: Tellurium-Free Thermoelectric: The Anisotropic n-Type Semiconductor Bi2S3
...
- papers: Enhanced low-temperature thermoelectrical properties of BiTeCl grown by topotactic method
...
- papers: Thermoelectric properties of Bi2.2−xPbxSr2Co2Oy system
...
- papers: Discovery of ZrCoBi based half Heuslers with high thermoelectric conversion efficiency
...
- papers: Sb and Se Substitution in CsBi4Te6: The Semiconductors CsM4Q6(M = Bi, Sb; Q = Te, Se), Cs2Bi10Q15, and CsBi5Q8
...
- papers: Transport properties of Bi2Sr2-xLaxCuO6+δ
...
- papers: Doping for higher thermoelectric properties in p-type BiCuSeO oxyselenide
...
- papers: Enhanced thermoelectric performance of BiCuSeO by increasing Seebeck coefficient through magnetic ion incorporation
...
- papers: Optimizing the thermoelectric transport properties of BiCuSeO via doping with the rare-earth variable-valence element Yb
...
- papers: Observation of a Magnetopiezoelectric Effect in the Antiferromagnetic Metal \nEuMnBi2
...
- papers: Thermoelectric Properties of Single Crystal EuBiSe3 Fiber
...
- papers: Incoherent effect of Fe and Ni substitutions in the ferromagnetic-insulator La0.6Bi0.4MnO3+δ
...
- papers: Solvothermal synthesis and thermoelectric properties of lanthanum contained Bi–Te and Bi–Se–Te alloys
...
- papers: Thermoelectric power singularities of FeNiBSi amorphous alloys
